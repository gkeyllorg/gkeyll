...
#define GET_MPI_OBJECT(type, value) \
  MPI_##type get_##value()          \
  {                                 \
    return value;                   \
  }
...
#define GET_INT_OBJECT(value) \
  int get_##value()           \
  {                           \
    return value;             \
  }
#define DECL_INT_OBJECT(value) int get_##value()
#define GET_INT_OBJECT_PTR(value) \
  int *get_##value()              \
  {                               \
    return value;                 \
  }
...
#define GET_VOID_OBJECT_PTR(value) \
  void *get_##value()              \
  {                                \
    return value;                  \
  }
...
#define GET_MPI_OBJECT_PTR(type, value) \
  MPI_##type *getPtr_##value()          \
  {                                     \
    return value;                       \
  }
...
#define GET_MPI_OBJ_SIZE(type) \
  int sizeof_##type()          \
  {                            \
    return sizeof(type);       \
  }
#define GET_MPI_OBJ_PTR_SIZE(type) \
  int sizeof_ptr_##type()          \
  {                                \
    return sizeof(type *);         \
  }
