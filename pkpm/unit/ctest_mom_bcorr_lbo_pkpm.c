...
test_bcorr_1x1v_p1()
{
  ...
  struct gkyl_mom_type *m = gkyl_mom_bcorr_lbo_pkpm_new(&cbasis, &pbasis, vBoundary, 1.0, false);
...
test_bcorr_1x1v_p2()
{
  ...
  struct gkyl_mom_type *m = gkyl_mom_bcorr_lbo_pkpm_new(&cbasis, &pbasis, vBoundary, 2.0, false);
