...
typedef double (*vlasov_pkpm_stream_surf_t)(
  ...
  const double *max_b, const double *pkpm_lax_l, const double *pkpm_lax_r, double *GKYL_RESTRICT out
);
...
GKYL_CU_DH static double kernel_vlasov_pkpm_vol_1x1v_ser_p1(
...
GKYL_CU_DH static double kernel_vlasov_pkpm_vol_1x1v_ser_p2(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_vlasov_pkpm_vol_1x1v_tensor_p2(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_vlasov_pkpm_vol_2x1v_ser_p1(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_vlasov_pkpm_vol_2x1v_tensor_p2(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_vlasov_pkpm_vol_3x1v_ser_p1(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_D static const gkyl_dg_vlasov_pkpm_accel_boundary_surf_kern_list
  ser_accel_boundary_surf_vpar_kernels[] = {
    // 1x kernels
    {NULL, vlasov_pkpm_boundary_surfvpar_1x1v_ser_p1, vlasov_pkpm_boundary_surfvpar_1x1v_ser_p2
    }, // 0
    // 2x kernels
...
GKYL_CU_D static const gkyl_dg_vlasov_pkpm_accel_boundary_surf_kern_list
  ten_accel_boundary_surf_vpar_kernels[] = {
    // 1x kernels
    {NULL, vlasov_pkpm_boundary_surfvpar_1x1v_ser_p1, vlasov_pkpm_boundary_surfvpar_1x1v_tensor_p2
    }, // 0
    // 2x kernels
    {NULL, vlasov_pkpm_boundary_surfvpar_2x1v_ser_p1, vlasov_pkpm_boundary_surfvpar_2x1v_tensor_p2
    }, // 1
    // 3x kernels
    {NULL, vlasov_pkpm_boundary_surfvpar_3x1v_ser_p1, NULL} // 2
};
