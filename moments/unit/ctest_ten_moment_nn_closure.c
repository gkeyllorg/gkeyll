...
static void test_nn_closure_dims(void)
{
...
// all gradients zero.
static void test_geom_1d_p1_uniform_bx(void)
{
...
static void test_geom_1d_p1_uniform_bz(void)
{
  struct gkyl_ten_moment_nn_closure *nn = mk_closure_1d(1, 0.1);
...
static void test_geom_1d_p1_diagonal_b(void)
{
  struct gkyl_ten_moment_nn_closure *nn = mk_closure_1d(1, 0.1);
...
static void test_geom_1d_p1_density_gradient(void)
{
  double dx = 0.1;
...
static void test_geom_1d_p1_pressure_gradient(void)
{
  double dx = 0.1;
  struct gkyl_ten_moment_nn_closure *nn = mk_closure_1d(1, dx);
...
static void test_geom_1d_p1_zero_b(void)
{
  struct gkyl_ten_moment_nn_closure *nn = mk_closure_1d(1, 0.1);
...
static void test_consume_1d_p1_sign_and_mapping(void)
{
  struct gkyl_ten_moment_nn_closure *nn = mk_closure_1d(1, 0.1);
...
static void test_consume_1d_p1_sign_flip(void)
{
  struct gkyl_ten_moment_nn_closure *nn = mk_closure_1d(1, 0.1);
...
static void test_consume_1d_p1_uniform_q_zero_source(void)
{
  struct gkyl_ten_moment_nn_closure *nn = mk_closure_1d(1, 0.1);
