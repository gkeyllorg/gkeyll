...
void
gr_euler_block_bc_updaters_init(
  const struct gkyl_wv_eqn *eqn, struct euler_block_data *bdata,
  const struct gkyl_block_connections *conn
)
{
...
void
gr_euler_nested_block_bc_updaters_init(
  const struct gkyl_wv_eqn *eqn, struct euler_block_data *bdata,
  const struct gkyl_block_connections *conn
)
{
...
void
euler_mixture_block_bc_updaters_init(
  const struct gkyl_wv_eqn *eqn, struct euler_block_data *bdata,
  const struct gkyl_block_connections *conn
)
{
