...
*/
GKYL_CU_D void gkyl_gr_spatial_metric_tensor_diff(
...
*/
GKYL_CU_D void gkyl_gr_spacetime_metric_tensor_diff(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
...
*/
GKYL_CU_D void gkyl_gr_lapse_function_diff(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
...
*/
GKYL_CU_D void gkyl_gr_shift_vector_diff(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
...
*/
GKYL_CU_D void gkyl_gr_spatial_christoffel_fd(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
...
*/
GKYL_CU_D void gkyl_gr_spacetime_christoffel_fd(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
  const double z, const double dt, const double dx, const double dy, const double dz,
...
*/
GKYL_CU_D void gkyl_gr_spatial_riemann_tensor_fd(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
  const double z, const double dx, const double dy, const double dz,
...
*/
GKYL_CU_D void gkyl_gr_spacetime_riemann_tensor_fd(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
  const double z, const double dt, const double dx, const double dy, const double dz,
...
*/
GKYL_CU_D void gkyl_gr_spatial_ricci_tensor_fd(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
...
*/
GKYL_CU_D void gkyl_gr_spacetime_ricci_tensor_fd(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
  const double z, const double dt, const double dx, const double dy, const double dz,
...
*/
GKYL_CU_D void gkyl_gr_spatial_ricci_scalar_fd(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
...
*/
GKYL_CU_D void gkyl_gr_spacetime_ricci_scalar_fd(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
  const double z, const double dt, const double dx, const double dy, const double dz,
...
*/
GKYL_CU_D void gkyl_gr_spatial_weyl_tensor_fd(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
...
*/
GKYL_CU_D void gkyl_gr_spacetime_weyl_tensor_fd(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
  const double z, const double dt, const double dx, const double dy, const double dz,
...
*/
GKYL_CU_D void gkyl_gr_conformal_factor_diff(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
...
*/
GKYL_CU_D void gkyl_gr_bssn_conformal_factor_diff(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
  const double z, const double dx, const double dy, const double dz,
...
*/
GKYL_CU_D void gkyl_gr_conformal_factor_diff2(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
  const double z, const double dx, const double dy, const double dz,
...
*/
GKYL_CU_D void gkyl_gr_bssn_conformal_factor_diff2(
  const struct gkyl_gr_spacetime *spacetime, const double t, const double x, const double y,
  const double z, const double dx, const double dy, const double dz,
