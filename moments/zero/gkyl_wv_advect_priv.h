...
*/
GKYL_CU_D static void advect_wall(
...
* @param ctx Context to pass to the function.
*/
GKYL_CU_D static void advect_no_slip(
  const struct gkyl_wv_eqn *eqn, double t, int nc, const double *skin, double *GKYL_RESTRICT ghost,
  void *ctx
);
...
*/
GKYL_CU_D static inline void advect_cons_to_diag(
...
*/
GKYL_CU_DH static inline void advect_source(
