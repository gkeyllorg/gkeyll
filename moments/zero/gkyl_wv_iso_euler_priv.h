...
*/
GKYL_CU_D static void iso_euler_wall(
...
* @param ctx Context to pass to the function.
*/
GKYL_CU_D static void iso_euler_no_slip(
  const struct gkyl_wv_eqn *eqn, double t, int nc, const double *skin, double *GKYL_RESTRICT ghost,
  void *ctx
);
...
*/
GKYL_CU_D static inline void iso_euler_cons_to_diag(
...
*/
GKYL_CU_DH static inline void iso_euler_source(
