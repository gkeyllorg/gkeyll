...
*/
GKYL_CU_D void gkyl_gr_ultra_rel_euler_prim_vars(
  double gas_gamma, const double q[70], double v[70]);
...
*/
GKYL_CU_D void gkyl_gr_ultra_rel_euler_stress_energy_tensor(
