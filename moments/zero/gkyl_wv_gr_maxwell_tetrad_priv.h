...
*/
GKYL_CU_D void gkyl_gr_maxwell_tetrad_flux(
...
*/
GKYL_CU_D void gkyl_gr_maxwell_tetrad_flux_correction(
  double light_speed, double e_fact, double b_fact, const double q[26], const double flux_sr[26],
  double flux_gr[26]
);
...
*/
GKYL_CU_D static void gr_maxwell_tetrad_wall(
