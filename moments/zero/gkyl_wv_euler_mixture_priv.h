...
*/
GKYL_CU_D void gkyl_euler_mixture_prim_vars(
...
*/
GKYL_CU_D static inline double gkyl_euler_mixture_max_abs_speed(
...
*/
GKYL_CU_D void gkyl_euler_mixture_flux(
...
*/
GKYL_CU_D static void euler_mixture_wall(
...
* @param ctx Context to pass to the function.
*/
GKYL_CU_D static void euler_mixture_no_slip(
  const struct gkyl_wv_eqn *eqn, double t, int nc, const double *skin, double *GKYL_RESTRICT ghost,
  void *ctx
);
...
*/
GKYL_CU_D static inline void euler_mixture_cons_to_diag(
...
*/
GKYL_CU_DH static inline void euler_mixture_source(
