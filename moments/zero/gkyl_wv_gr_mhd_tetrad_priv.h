...
*/
GKYL_CU_D void gkyl_gr_mhd_tetrad_flux(
...
* @param flux Flux vector in direction 'dir' (output).
*/
GKYL_CU_D void gkyl_gr_mhd_tetrad_flux_correction(
...
*/
GKYL_CU_D void gkyl_gr_mhd_tetrad_inv_spatial_metric(
  const double q[75], double ***inv_spatial_metric
);
...
*/
GKYL_CU_D void gkyl_gr_mhd_tetrad_stress_energy_tensor(
...
*/
GKYL_CU_D static inline double gkyl_gr_mhd_tetrad_max_abs_speed(
...
*/
GKYL_CU_D static void gr_mhd_tetrad_tetrad_wall(
...
* @param ctx Context to pass to the function.
*/
GKYL_CU_D static void gr_mhd_tetrad_tetrad_no_slip(
  const struct gkyl_wv_eqn *eqn, double t, int nc, const double *skin, double *GKYL_RESTRICT ghost,
  void *ctx
);
...
*/
GKYL_CU_D static inline void gr_mhd_tetrad_cons_to_diag(
...
*/
GKYL_CU_DH static inline void gr_mhd_tetrad_source(
