...
void gkyl_wv_can_pb_incompress_euler_free(const struct gkyl_ref_count *ref)
{
  ...
  struct wv_can_pb_incompress_euler *can_pb_incompress_euler =
    container_of(base, struct wv_can_pb_incompress_euler, eqn);
...
struct gkyl_wv_eqn *gkyl_wv_can_pb_incompress_euler_new()
{
  ...
  can_pb_incompress_euler->eqn.ref_count =
    gkyl_ref_count_init(gkyl_wv_can_pb_incompress_euler_free);
  can_pb_incompress_euler->eqn.on_dev =
    &can_pb_incompress_euler->eqn; // CPU eqn obj points to itself
...
void gkyl_wv_can_pb_hasegawa_mima_free(const struct gkyl_ref_count *ref)
{
  ...
  struct wv_can_pb_hasegawa_mima *can_pb_hasegawa_mima =
    container_of(base, struct wv_can_pb_hasegawa_mima, eqn);
...
void gkyl_wv_can_pb_hasegawa_wakatani_free(const struct gkyl_ref_count *ref)
{
  ...
  struct wv_can_pb_hasegawa_wakatani *can_pb_hasegawa_wakatani =
    container_of(base, struct wv_can_pb_hasegawa_wakatani, eqn);
...
struct gkyl_wv_eqn *gkyl_wv_can_pb_hasegawa_wakatani_new(double alpha, bool is_modified)
{
  ...
  can_pb_hasegawa_wakatani->eqn.ref_count =
    gkyl_ref_count_init(gkyl_wv_can_pb_hasegawa_wakatani_free);
  can_pb_hasegawa_wakatani->eqn.on_dev =
    &can_pb_hasegawa_wakatani->eqn; // CPU eqn obj points to itself
