...
*/
GKYL_CU_D void gkyl_gr_twofluid_tetrad_flux(
...
*/
GKYL_CU_D void gkyl_gr_twofluid_tetrad_flux_correction(
  double gas_gamma_elc, double gas_gamma_ion, double light_speed, double e_fact, double b_fact,
...
*/
GKYL_CU_D void gkyl_gr_twofluid_tetrad_prim_vars(
  double gas_gamma_elc, double gas_gama_ion, const double q[84], double v[84]
);
...
*/
GKYL_CU_D void gkyl_gr_twofluid_tetrad_inv_spatial_metric(
  const double q[84], double ***inv_spatial_metric
);
...
*/
GKYL_CU_D void gkyl_gr_twofluid_tetrad_stress_energy_tensor_elc(
...
* @param stress_energy Stress-energy tensor (output).
*/
GKYL_CU_D void gkyl_gr_twofluid_tetrad_tress_energy_tensor_ion(
...
*/
GKYL_CU_D static inline double gkyl_gr_twofluid_tetrad_max_abs_speed(
...
*/
GKYL_CU_D static void gr_twofluid_tetrad_wall(
...
* @param ctx Context to pass to the function.
*/
GKYL_CU_D static void gr_twofluid_tetrad_no_slip(
  const struct gkyl_wv_eqn *eqn, double t, int nc, const double *skin, double *GKYL_RESTRICT ghost,
  void *ctx
);
...
*/
GKYL_CU_D static inline void gr_twofluid_tetrad_cons_to_diag(
...
*/
GKYL_CU_DH static inline void gr_twofluid_tetrad_source(
