...
*/
GKYL_CU_D void gkyl_gr_maxwell_flux(
...
*/
GKYL_CU_D static inline double gkyl_gr_maxwell_max_abs_speed(double light_speed, const double q[26]);
...
*/
GKYL_CU_D static void gr_maxwell_wall(
...
*/
GKYL_CU_D static inline void gr_maxwell_cons_to_diag(
...
*/
GKYL_CU_DH static inline void gr_maxwell_source(
