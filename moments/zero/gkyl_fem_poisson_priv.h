...
static const lhsstencil_kern_bcx_list_2x
  ser_lhsstencil_consteps_list_2x[] =
    {
      // periodicx
      {
        .list =
...
GKYL_CU_D static const srcstencil_kern_bcx_list_2x
...
static long
gkyl_fem_poisson_global_num_nodes(
...
GKYL_CU_D static void
fem_poisson_choose_lhs_kernels(
  const struct gkyl_basis *basis, const struct gkyl_poisson_bc *bcs, bool isvareps,
  lhsstencil_t *lhsout
)
{
...
GKYL_CU_D static void
fem_poisson_choose_src_kernels(
  const struct gkyl_basis *basis, const struct gkyl_poisson_bc *bcs, bool isvareps,
  srcstencil_t *srcout
)
{
