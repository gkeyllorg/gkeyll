...
int main(int argc, char **argv)
{
  ...
  // Fluid equations.
  struct gkyl_wv_eqn *gr_mhd = gkyl_wv_gr_mhd_new(
    ctx.gas_gamma, ctx.light_speed, ctx.b_fact, ctx.spacetime_gauge, ctx.reinit_freq, ctx.spacetime,
    app_args.use_gpu
  );
