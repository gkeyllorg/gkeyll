...
void test_conf_phase_accumulate_subtract_p1()
{
  test_subspace_accumulate(1, false);
}
void test_conf_phase_accumulate_subtract_p2()
{
...
void test_conf_phase_accumulate_subtract_p1_cu()
{
  test_subspace_accumulate(1, true);
}
void test_conf_phase_accumulate_subtract_p2_cu()
{
