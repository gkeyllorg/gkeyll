...
static void test_L_domain_send_c1(void)
{
...
static void test_L_domain_send_c3(void)
{
...
static void test_L_domain_recv_c1(void)
{
  struct gkyl_block_geom *geom = create_L_domain((int[]){1, 1});
  struct gkyl_block_topo *topo = gkyl_block_geom_topo(geom);
...
static void test_L_domain_recv_c3(void)
{
