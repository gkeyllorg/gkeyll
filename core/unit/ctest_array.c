...
void test_grid_sub_array_read_1()
{
...
void test_grid_sub_array_read_2()
{
  double lower[] = {1.0, 1.0}, upper[] = {2.5, 5.0};
  int cells[] = {20, 60};
  struct gkyl_rect_grid grid;
...
void test_grid_array_new_from_file_1()
{
  double lower[] = {1.0, 1.0}, upper[] = {2.5, 5.0};
  int cells[] = {20, 60};
  struct gkyl_rect_grid grid;
...
void test_grid_array_read_p1(void)
{
  // read just header
  struct gkyl_rect_grid grid;
  struct gkyl_array_header_info hdr;
...
static void test_array_from_buff(void)
{
