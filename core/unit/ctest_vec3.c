...
void test_vec3_triple()
{
  ...
  double det =
    1.0 * (5.0 * 10.0 - 6.0 * 8.0) - 2.0 * (4.0 * 10.0 - 6.0 * 7.0) + 3.0 * (4.0 * 8.0 - 5.0 * 7.0);
...
TEST_LIST = {{"vec3_basic", test_vec3_basic},     {"vec3_scale", test_vec3_scale},
             {"vec3_add_sub", test_vec3_add_sub}, {"vec3_len_norm", test_vec3_len_norm},
             {"vec3_dot", test_vec3_dot},         {"vec3_cross", test_vec3_cross},
             {"vec3_triple", test_vec3_triple},   {"vec3_polar", test_vec3_polar},
             {"minmod_2", test_minmod_2},         {"minmod_3", test_minmod_3},
             {"minmod_4", test_minmod_4},         {"median", test_median},
             {"min_max_3", test_min_max_3},       {NULL, NULL}};
