...
static void test_ranges_from_range_2d(void)
{
...
static void test_ranges_from_range_3d(void)
{
  struct gkyl_range inlocal;
...
static void test_rect_decomp_2d(void)
{
...
static void test_rect_decomp_3d(void)
{
  struct gkyl_range range;
...
static void test_rect_decomp_4d(void)
{
  struct gkyl_range range;
...
static void test_rect_decomp_per_2d(void)
{
  struct gkyl_range range;
  gkyl_range_init(&range, 2, (int[]){1, 2}, (int[]){100, 100});
...
static void test_rect_decomp_per_2d_2(void)
{
  struct gkyl_range range;
  gkyl_range_init(&range, 2, (int[]){1, 2}, (int[]){100, 100});
...
static void test_rect_decomp_per_2d_corner(void)
{
  struct gkyl_range range;
  gkyl_range_init(&range, 2, (int[]){1, 2}, (int[]){100, 100});
...
static void test_rect_decomp_per_3d(void)
{
  struct gkyl_range range;
...
static void test_rect_decomp_2d_2v(void)
{
  struct gkyl_range range;
  gkyl_range_init(&range, 2, (int[]){1, 2}, (int[]){100, 100});
...
static void test_rect_decomp_from_cuts_and_cells(void)
{
  int cuts[] = {5, 6, 7};
