...
void test_sub_range_split()
{
  ...
  int start_idx[] = {
    gkyl_ridx(subrange, 2, 2), gkyl_ridx(subrange, 3, 2), gkyl_ridx(subrange, 4, 2),
...
static void test_perp_extend(void)
{
  int lo[] = {1, 1}, up[] = {4, 8};
...
static void test_skin_ghost(void)
{
...
static void test_skin_ghost_with_corners(void)
{
  struct gkyl_range rng;
  gkyl_range_init(&rng, 2, (int[]){2, 3}, (int[]){100, 85});
...
static void test_range_edge_match(void)
{
