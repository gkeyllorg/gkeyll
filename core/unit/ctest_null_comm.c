...
void test_io_p1_p4(void)
{
  struct gkyl_rect_grid grid;
  struct gkyl_array_header_info hdr;
  gkyl_grid_sub_array_header_read(&grid, &hdr, "core/data/unit/ser-euler_riem_2d_hllc-euler_1.gkyl");
