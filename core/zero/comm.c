...
int
gkyl_comm_allreduce(
  struct gkyl_comm *pcomm, enum gkyl_elem_type type, enum gkyl_array_op op, int nelem,
...
gkyl_comm_array_allgather(
  struct gkyl_comm *pcomm, const struct gkyl_range *local, const struct gkyl_range *global,
...
gkyl_comm_array_bcast(
  struct gkyl_comm *pcomm, const struct gkyl_array *array_send, struct gkyl_array *array_recv,
  int root
)
{
  struct gkyl_comm_priv *comm = container_of(pcomm, struct gkyl_comm_priv, pub_comm);
...
gkyl_comm_array_sync(
  struct gkyl_comm *pcomm, const struct gkyl_range *local, const struct gkyl_range *local_ext,
...
gkyl_comm_array_write(
  struct gkyl_comm *pcomm, const struct gkyl_rect_grid *grid, const struct gkyl_range *range,
...
struct gkyl_comm *
gkyl_comm_create_comm_from_ranks(
  const struct gkyl_comm *pcomm, int nranks, const int *ranks, struct gkyl_rect_decomp *new_decomp,
  bool *is_valid
)
{
  struct gkyl_comm_priv *comm = container_of(pcomm, struct gkyl_comm_priv, pub_comm);
