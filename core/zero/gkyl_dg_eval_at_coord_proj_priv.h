...
GKYL_CU_D static struct dg_ev_proj_kernels *dg_eval_at_coord_choose_ker(bool use_gpu, int cdim,
  int ndim, const struct gkyl_basis *basis, int num_eval_dirs, const int *eval_dirs)
{
