...
GKYL_CU_D static struct {
  void (*n2m[4])(const double *fnodal, double *fmodal);
} n2m_quad_surf_list_x[] = { { NULL, NULL, NULL, NULL }, // No 0D basis functions
...
GKYL_CU_D static struct {
  void (*n2m[4])(const double *fnodal, double *fmodal);
} n2m_quad_surf_list_y[] = { { NULL, NULL, NULL, NULL }, // No 0D basis functions
  { NULL, NULL, NULL, NULL }, // No 1D basis functions
...
GKYL_CU_D static struct {
  void (*nl[4])(double *node_list);
} nl_quad_surf_list_x[] = { { NULL, NULL, NULL, NULL }, // No 0D basis functions
  { NULL, NULL, NULL, NULL }, // No 1D basis functions
...
GKYL_CU_D static struct {
  void (*nl[4])(double *node_list);
} nl_quad_surf_list_y[] = { { NULL, NULL, NULL, NULL }, // No 0D basis functions
  { NULL, NULL, NULL, NULL }, // No 1D basis functions
