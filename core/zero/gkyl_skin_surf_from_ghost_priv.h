...
GKYL_CU_D static void skin_surf_from_ghost_choose_kernel(const struct gkyl_basis basis,
  enum gkyl_edge_loc edge, int dir, bool use_gpu, struct gkyl_skin_surf_from_ghost_kernels *kernels)
{
#ifdef GKYL_HAVE_CUDA
  if (use_gpu) {
