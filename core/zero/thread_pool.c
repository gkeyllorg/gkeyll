...
static void thread_pool_free(const struct gkyl_ref_count *ref)
{
...
static bool thread_pool_add_work(const struct gkyl_job_pool *jp, jp_work_func func, void *ctx)
{
...
static void thread_pool_wait(const struct gkyl_job_pool *jp)
{
  struct jp_thread_pool *th = container_of(jp, struct jp_thread_pool, jp);
