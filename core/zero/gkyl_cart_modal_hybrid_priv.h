...
} eve_list[] = { { NULL, NULL, NULL, NULL }, // No 0x basis functions
...
} fos_list[] = { { NULL, NULL, NULL, NULL }, // No 0x basis functions
...
GKYL_CU_D static struct {
  void (*fs[4])(int dir, const double *f, double *fout);
} fes_list[] = { { NULL, NULL, NULL, NULL }, // No 0x basis functions
...
GKYL_CU_D static struct {
  ...
  { 0, 6, 16, 40 }, { 0, 12, 32, 80 }, { 0, 24, 64, 160 } };
...
} n2m_list[] = { { NULL, NULL, NULL, NULL }, // No 0x basis functions
...
} qn2m_list[] = { { NULL, NULL, NULL, NULL }, // No 0x basis functions
...
} m2qn_list[] = { { NULL, NULL, NULL, NULL }, // No 0x basis functions
