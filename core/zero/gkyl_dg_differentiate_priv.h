...
GKYL_CU_D static const differentiate_op_kern_list ten_differentiate_list[3][3][2] = { // ndim = 1
  {// dir0
   {
     {dg_differentiate_local_ser_1x_p1_dir0_order1, dg_differentiate_local_tensor_1x_p2_dir0_order1,
      NULL}, // order1
     {dg_differentiate_local_ser_1x_p1_dir0_order2, dg_differentiate_local_tensor_1x_p2_dir0_order2,
      NULL} // order2
   },
   // dir1: not applicable for 1D
   {{NULL, NULL, NULL}, {NULL, NULL, NULL}},
  ...
  {// dir0
   {
     {dg_differentiate_local_ser_2x_p1_dir0_order1, dg_differentiate_local_tensor_2x_p2_dir0_order1,
      NULL}, // order1
     {dg_differentiate_local_ser_2x_p1_dir0_order2, dg_differentiate_local_tensor_2x_p2_dir0_order2,
      NULL} // order2
   },
   // dir1
   {
     {dg_differentiate_local_ser_2x_p1_dir1_order1, dg_differentiate_local_tensor_2x_p2_dir1_order1,
      NULL}, // order1
     {dg_differentiate_local_ser_2x_p1_dir1_order2, dg_differentiate_local_tensor_2x_p2_dir1_order2,
      NULL} // order2
   },
   // dir2: not applicable for 2D
   {{NULL, NULL, NULL}, {NULL, NULL, NULL}}
