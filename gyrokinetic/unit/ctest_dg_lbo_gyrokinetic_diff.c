...
test_lbo_diff_ctor()
{
  ...
  double mass = 2.5;
  struct gkyl_dg_eqn *eqn = gkyl_dg_lbo_gyrokinetic_diff_new(&e.confBasis, &e.basis,
  ...
  struct dg_lbo_gyrokinetic_diff *diff =
    container_of(eqn, struct dg_lbo_gyrokinetic_diff, eqn);
