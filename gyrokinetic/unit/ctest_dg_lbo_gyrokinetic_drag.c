...
void test_lbo_drag_ctor()
{
  struct lbo_env e;
  lbo_env_init(&e);

  double mass = 2.5;
  struct gkyl_dg_eqn *eqn = gkyl_dg_lbo_gyrokinetic_drag_new(
  ...
  struct dg_lbo_gyrokinetic_drag *drag = container_of(eqn, struct dg_lbo_gyrokinetic_drag, eqn);
