...
void gkyl_gk_neut_fluid_prim_vars_flow_energy_advance(
...
test_prim_vars_udrift_pressure_temp()
{
  ...
  // --- udrift ---
  {
    struct gkyl_gk_neut_fluid_prim_vars *up = gkyl_gk_neut_fluid_prim_vars_new(
      gas_gamma, mass, &s.basis, &s.grid, &s.local, GKYL_GK_NEUT_FLUID_PRIM_VARS_UDRIFT, true, false
    );
  ...
  {
    struct gkyl_gk_neut_fluid_prim_vars *up = gkyl_gk_neut_fluid_prim_vars_new(
      gas_gamma, mass, &s.basis, &s.grid, &s.local, GKYL_GK_NEUT_FLUID_PRIM_VARS_PRESSURE, true,
      false
    );
  ...
  {
    struct gkyl_gk_neut_fluid_prim_vars *up = gkyl_gk_neut_fluid_prim_vars_new(
      gas_gamma, mass, &s.basis, &s.grid, &s.local, GKYL_GK_NEUT_FLUID_PRIM_VARS_TEMP, true, false
    );
    struct gkyl_array *out = gkyl_array_new(GKYL_DOUBLE, 1, s.local_ext.volume);
    gkyl_array_clear(out, 0.0);
  ...
  {
    struct gkyl_gk_neut_fluid_prim_vars *up = gkyl_gk_neut_fluid_prim_vars_new(
      gas_gamma, mass, &s.basis, &s.grid, &s.local, GKYL_GK_NEUT_FLUID_PRIM_VARS_FLOW_ENERGY, true,
      false
    );
    struct gkyl_array *out = gkyl_array_new(GKYL_DOUBLE, 1, s.local_ext.volume);
    gkyl_array_clear(out, 0.0);
...
test_prim_vars_combined()
{
  ...
  {
    struct gkyl_gk_neut_fluid_prim_vars *up = gkyl_gk_neut_fluid_prim_vars_new(
      gas_gamma, mass, &s.basis, &s.grid, &s.local, GKYL_GK_NEUT_FLUID_PRIM_VARS_UDRIFT_PRESSURE,
      true, false
    );
  ...
  {
    struct gkyl_gk_neut_fluid_prim_vars *up = gkyl_gk_neut_fluid_prim_vars_new(
      gas_gamma, mass, &s.basis, &s.grid, &s.local, GKYL_GK_NEUT_FLUID_PRIM_VARS_UDRIFT_TEMP, true,
      false
    );
    struct gkyl_array *out = gkyl_array_new(GKYL_DOUBLE, 4, s.local_ext.volume);
    gkyl_array_clear(out, 0.0);
  ...
  {
    struct gkyl_gk_neut_fluid_prim_vars *up = gkyl_gk_neut_fluid_prim_vars_new(
      gas_gamma, mass, &s.basis, &s.grid, &s.local, GKYL_GK_NEUT_FLUID_PRIM_VARS_LTE, true, false
    );
