...
void test_p1_deflated()
{
  ...
  for (int zidx = local.lower[1]; zidx <= local.upper[1]; zidx++) {
    ...
    gkyl_nodal_ops_m2n_deflated(
      n2m_1d, deflated_basis_on_dev, &deflated_grid, &nrange, &deflated_nrange, &deflated_local, 1,
      nodal_fld_dev, deflated_funcdg_dev, zidx - 1
    );
    if (zidx == local.upper[1]) {
      ...
      gkyl_nodal_ops_m2n_deflated(
        n2m_1d, deflated_basis_on_dev, &deflated_grid, &nrange, &deflated_nrange, &deflated_local,
        1, nodal_fld_dev, deflated_funcdg_dev, zidx
      );
    }
  }
...
void test_p1_deflated_3d()
{
  ...
  for (int zidx = local.lower[2]; zidx <= local.upper[2]; zidx++) {
    ...
    gkyl_nodal_ops_m2n_deflated(
      n2m_2d, deflated_basis_on_dev, &deflated_grid, &nrange, &deflated_nrange, &deflated_local, 1,
      nodal_fld_dev, deflated_funcdg_dev, zidx - 1
    );
    if (zidx == local.upper[2]) {
      ...
      gkyl_nodal_ops_m2n_deflated(
        n2m_2d, deflated_basis_on_dev, &deflated_grid, &nrange, &deflated_nrange, &deflated_local,
        1, nodal_fld_dev, deflated_funcdg_dev, zidx
      );
    }
  }
