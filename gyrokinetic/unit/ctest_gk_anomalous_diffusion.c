...
test_anom_diff_ctor_local()
{
  ...
  struct gkyl_dg_eqn *eqn = gkyl_gk_anomalous_diffusion_new(
    &basis, &cbasis, &confRange, GKYL_BC_GK_SPECIES_COPY, GKYL_BC_GK_SPECIES_COPY, false
  );
...
test_anom_diff_ctor_zeroflux()
{
  ...
  struct gkyl_dg_eqn *eqn = gkyl_gk_anomalous_diffusion_new(
    &basis, &cbasis, &confRange, GKYL_BC_GK_SPECIES_ZERO_FLUX, GKYL_BC_GK_SPECIES_ZERO_FLUX, false
  );
