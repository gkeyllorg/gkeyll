...
void test_position_map_init_1x()
{
  int cells[] = {32};
  int poly_order = 1;
...
void test_position_map_init_1x_null()
{
  int cells[] = {8};
  int poly_order = 1;
  double lower[] = {0.0}, upper[] = {1.0};
...
void test_position_map_init_2x()
{
  int cells[] = {8, 8};
  int poly_order = 1;
...
void test_position_map_init_3x()
{
  int cells[] = {8, 8, 8};
  int poly_order = 1;
...
void test_gkyl_position_map_eval_mc2nu()
{
  int cells[] = {8, 8, 8};
  int poly_order = 2;
  double lower[] = {0.0, 0.0, 0.0}, upper[] = {1.0, 1.0, 1.0};
...
void test_gkyl_position_map_slope()
{
  int cells[] = {8, 8, 8};
  int poly_order = 2;
  double lower[] = {0.0, 0.0, 0.0}, upper[] = {1.0, 1.0, 1.0};
...
void test_position_map_numeric_optimize_1x()
{
  int cells[] = {64};
  int poly_order = 1;
  double lower[] = {-M_PI + 1e-2}, upper[] = {M_PI - 1e-2};
...
void test_position_map_numeric_calculate_1x()
{
  int cells[] = {64};
  int poly_order = 1;
  double lower[] = {-M_PI + 1e-2}, upper[] = {M_PI - 1e-2};
