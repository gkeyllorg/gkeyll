...
)
{
  ...
  gkyl_dg_calc_gk_rad_vars_nI_nu_advance(
    calc_gk_rad_vars, &confLocal, &local, &vnu_surf[0], &vnu[0], &vsqnu_surf[0], &vsqnu[0], n_elc,
    m0, m0, nvnu_surf, nvnu, nvsqnu_surf, nvsqnu, vtsq_min_normalized, vtsq
  );
...
void test_2x(int poly_order, bool use_gpu, double te)
{
  ...
  gkyl_dg_calc_gk_rad_vars_nu_advance(
    calc_gk_rad_vars, &confLocal, &local, a[0], alpha[0], beta[0], gamma[0], v0[0],
    vnu_surf[0].data[ne_interval - 1].arr, vnu[0].data[ne_interval - 1].arr,
    vsqnu_surf[0].data[ne_interval - 1].arr, vsqnu[0].data[ne_interval - 1].arr
  );
...
void test_1x2v_p1_Li1_lowNe()
{
  test_1x(1, false, 30.0, 3, 1, num_ne2, 1);
}
void test_1x2v_p1_Li1_midNe()
{
  test_1x(1, false, 30.0, 3, 1, num_ne2, 6);
}
void test_1x2v_p1_Li1_highNe()
{
...
void test_1x2v_p1_gpu()
{
  test_1x(1, true, 30.0, 3, 0, num_ne, 1);
}
void test_1x2v_p1_L1_midNe_gpu()
{
