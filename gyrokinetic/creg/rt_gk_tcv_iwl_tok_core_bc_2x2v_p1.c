// TCV inner-wall-limited 2x2v test with the up-down tokamak core BC on the inner
// radial boundary (GKYL_BC_GK_SPECIES_UPDOWN_TOK_CORE) for both species. Copy
// of rt_gk_tcv_iwl_adapt_source_2x2v_p1.c otherwise.
#include <math.h>
#include <stdio.h>
#include <time.h>
...
//      .write_diagnostics = true,
    ...
    .bcs = {
      { .dir = 0, .edge = GKYL_LOWER_EDGE, .type = GKYL_BC_GK_SPECIES_UPDOWN_TOK_CORE }, // Up-down tokamak core BC.
