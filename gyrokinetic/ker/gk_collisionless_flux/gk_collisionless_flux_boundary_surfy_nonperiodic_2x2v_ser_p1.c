...
{ 
  ...
  gkyl_gk_collisionless_yfield_add(&ypotderR[2], -(3.4641016151377544*phiR[0]*q_*rdz2)-2.4494897427831783*bmag[0]*vmap[2]*rdz2);
  gkyl_gk_collisionless_yfield_add(&ypotderR[5], -(3.4641016151377544*phiR[1]*q_*rdz2)-2.4494897427831783*bmag[1]*vmap[2]*rdz2);
  gkyl_gk_collisionless_yfield_add(&ypotderR[9], -(2.4494897427831783*bmag[0]*vmap[3]*rdz2));
  gkyl_gk_collisionless_yfield_add(&ypotderR[12], -(2.4494897427831783*bmag[1]*vmap[3]*rdz2));
