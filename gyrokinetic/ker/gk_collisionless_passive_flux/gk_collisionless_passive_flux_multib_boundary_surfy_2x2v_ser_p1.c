...
{ 
  ...
  alpha_quad = 0.8660254037844386*speedsR[7]-0.8660254037844386*speedsR[6]-0.5*speedsR[5]+0.5*speedsR[4];
  ...
  alpha_quad = 0.5*(speedsR[5]+speedsR[4])-0.8660254037844386*(speedsR[7]+speedsR[6]);
