...
{ 
  ...
  alpha_quad = -(0.8660254037844386*speedsL[7])+0.8660254037844386*speedsL[6]-0.5*speedsL[5]+0.5*speedsL[4];
  ...
  alpha_quad = 0.8660254037844386*(speedsL[7]+speedsL[6])+0.5*(speedsL[5]+speedsL[4]);
