...
{ 
  ...
  alpha_quad = -(0.6123724356957944*speedsR[23])+0.6123724356957944*(speedsR[22]+speedsR[21])+0.3535533905932737*speedsR[20]-0.6123724356957944*speedsR[19]-0.3535533905932737*(speedsR[18]+speedsR[17])+0.3535533905932737*speedsR[16];
  ...
  alpha_quad = 0.6123724356957944*speedsR[23]-0.6123724356957944*speedsR[22]+0.6123724356957944*speedsR[21]-0.3535533905932737*speedsR[20]-0.6123724356957944*speedsR[19]+0.3535533905932737*speedsR[18]-0.3535533905932737*speedsR[17]+0.3535533905932737*speedsR[16];
  ...
  alpha_quad = 0.6123724356957944*(speedsR[23]+speedsR[22])-0.6123724356957944*speedsR[21]-0.3535533905932737*speedsR[20]-0.6123724356957944*speedsR[19]-0.3535533905932737*speedsR[18]+0.3535533905932737*(speedsR[17]+speedsR[16]);
  ...
  alpha_quad = -(0.6123724356957944*(speedsR[23]+speedsR[22]+speedsR[21]))+0.3535533905932737*speedsR[20]-0.6123724356957944*speedsR[19]+0.3535533905932737*(speedsR[18]+speedsR[17]+speedsR[16]);
