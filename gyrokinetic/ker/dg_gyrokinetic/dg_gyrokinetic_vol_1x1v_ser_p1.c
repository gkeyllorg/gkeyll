...
{ 
  ...
  alphax[2] = (2.23606797749979*rtg33inv[0]*hamil[4]*rdx2)/(vmap[1]*m_); 
  alphax[3] = (2.23606797749979*rtg33inv[1]*hamil[4]*rdx2)/(vmap[1]*m_); 
  ...
  alphavpar[2] = (-(0.5773502691896258*rtg33inv[1]*yfield[3])-0.5773502691896258*rtg33inv[0]*yfield[2])/(vmap[1]*m_); 
  alphavpar[3] = (-(0.5773502691896258*rtg33inv[0]*yfield[3])-0.5773502691896258*rtg33inv[1]*yfield[2])/(vmap[1]*m_); 
  alphavpar[4] = (-(0.5773502691896257*rtg33inv[1]*yfield[5])-0.5773502691896258*rtg33inv[0]*yfield[4])/(vmap[1]*m_); 
  alphavpar[5] = (-(0.5773502691896258*rtg33inv[0]*yfield[5])-0.5773502691896257*rtg33inv[1]*yfield[4])/(vmap[1]*m_); 
