...
gkyl_lbo_gyrokinetic_drag_set_auxfields_cu_kernel(
...
__global__ static void
dg_lbo_gyrokinetic_drag_set_cu_dev_ptrs(
  struct dg_lbo_gyrokinetic_drag *lbo, enum gkyl_basis_type b_type, int cv_index, int cdim,
...
struct gkyl_dg_eqn *
gkyl_dg_lbo_gyrokinetic_drag_cu_dev_new(
