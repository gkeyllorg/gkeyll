...
typedef void (*gyrokinetic_cross_prim_moms_bgk_t)(
...
GKYL_CU_D static const gkyl_gyrokinetic_cross_prim_moms_bgk_kern_list
  ser_gyrokinetic_cross_prim_moms_bgk_list[] = {
    ...
    // 2x kernels
    {NULL, gyrokinetic_cross_prim_moms_bgk_2x2v_ser_p1, NULL
    }, // no gyrokinetic_cross_prim_moms_bgk_2x2v_ser_p2 due to the lack of gkyl_basis_ser_2x_p2_inv.h //2
    // 3x kernels
    {NULL, gyrokinetic_cross_prim_moms_bgk_3x2v_ser_p1, NULL
    } // no gyrokinetic_cross_prim_moms_bgk_2x2v_ser_p2 due to the lack of gkyl_basis_ser_3x_p2_inv.h //3
};
