...
typedef void (*sheathker_t)(
  const double sheathDirDx, double q_e, double m_e, double T_e, const double *cmag,
  const double *jacobtotInv, const double *GammaJac_i, const double *m0Ion, const double *m0JacIon,
  double *out
);
