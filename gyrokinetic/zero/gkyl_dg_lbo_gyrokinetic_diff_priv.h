...
kernel_lbo_gyrokinetic_diff_vol_1x1v_ser_p1(
...
GKYL_CU_DH static double
kernel_lbo_gyrokinetic_diff_vol_1x2v_ser_p1(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double
kernel_lbo_gyrokinetic_diff_vol_2x2v_ser_p1(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double
kernel_lbo_gyrokinetic_diff_vol_3x2v_ser_p1(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
