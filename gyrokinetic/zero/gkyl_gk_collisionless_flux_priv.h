...
GKYL_CU_D static gk_collisionless_flux_surfvpar_t choose_gk_collisionless_flux_surf_vpar_kern(
...
GKYL_CU_D static gk_collisionless_flux_surfvpar_t choose_gk_collisionless_flux_no_by_surf_vpar_kern(
  int cdim, int vdim, int poly_order)
{
