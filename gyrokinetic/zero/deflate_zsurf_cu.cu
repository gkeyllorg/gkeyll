...
__global__ void
gkyl_deflate_zsurf_advance_cu_kernel(
  const struct gkyl_deflate_zsurf *up, int zidx, struct gkyl_range range,
  struct gkyl_range deflated_range, const struct gkyl_array *field,
