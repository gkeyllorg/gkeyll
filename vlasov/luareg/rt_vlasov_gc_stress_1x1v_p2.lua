...
t_end = 1.0 -- Shortened: this test guards the GC-lifetime invariant, not physics.
...
-- Force a full garbage-collection cycle: the species/field userdata created
-- in the App constructor's table argument have no other references from Lua,
-- so only the App's anchoring keeps them (and the callback contexts inside
-- them) alive past this point.
