...
GKYL_CU_DH static double kernel_canonical_pb_vol_1x1v_ser_p1(
...
GKYL_CU_DH static double kernel_canonical_pb_vol_1x1v_ser_p2(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_1x2v_ser_p1(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_1x2v_ser_p2(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_1x3v_ser_p1(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_1x3v_ser_p2(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_2x2v_ser_p1(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_2x2v_ser_p2(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_2x3v_ser_p1(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_2x3v_ser_p2(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_1x1v_tensor_p1(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_1x1v_tensor_p2(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_1x2v_tensor_p1(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_1x2v_tensor_p2(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_1x3v_tensor_p1(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_1x3v_tensor_p2(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_2x2v_tensor_p1(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_2x2v_tensor_p2(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_2x3v_tensor_p1(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_DH static double kernel_canonical_pb_vol_3x3v_tensor_p1(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut
)
{
...
GKYL_CU_D static const gkyl_dg_canonical_pb_accel_boundary_surf_kern_list
  tensor_accel_boundary_surf_vx_kernels[] = {
    // 1x kernels
    {NULL, canonical_pb_boundary_surfvx_1x1v_tensor_p1, canonical_pb_boundary_surfvx_1x1v_tensor_p2
    }, // 0
    {NULL, canonical_pb_boundary_surfvx_1x2v_tensor_p1, canonical_pb_boundary_surfvx_1x2v_tensor_p2
    }, // 1
    {NULL, canonical_pb_boundary_surfvx_1x3v_tensor_p1, canonical_pb_boundary_surfvx_1x3v_tensor_p2
    }, // 2
    // 2x kernels
    {NULL, canonical_pb_boundary_surfvx_2x2v_tensor_p1, canonical_pb_boundary_surfvx_2x2v_tensor_p2
    }, // 3
...
GKYL_CU_D static const gkyl_dg_canonical_pb_accel_boundary_surf_kern_list
  tensor_accel_boundary_surf_vy_kernels[] = {
    // 1x kernels
    {NULL, NULL, NULL}, // 0
    {NULL, canonical_pb_boundary_surfvy_1x2v_tensor_p1, canonical_pb_boundary_surfvy_1x2v_tensor_p2
    }, // 1
    {NULL, canonical_pb_boundary_surfvy_1x3v_tensor_p1, canonical_pb_boundary_surfvy_1x3v_tensor_p2
    }, // 2
    // 2x kernels
    {NULL, canonical_pb_boundary_surfvy_2x2v_tensor_p1, canonical_pb_boundary_surfvy_2x2v_tensor_p2
    }, // 3
...
GKYL_CU_D static const gkyl_dg_canonical_pb_accel_boundary_surf_kern_list
  tensor_accel_boundary_surf_vz_kernels[] = {
    ...
    {NULL, NULL, NULL}, // 0
    {NULL, NULL, NULL}, // 1
    {NULL, canonical_pb_boundary_surfvz_1x3v_tensor_p1, canonical_pb_boundary_surfvz_1x3v_tensor_p2
    }, // 2
    // 2x kernels
    {NULL, NULL, NULL}, // 3
...
GKYL_CU_D static const gkyl_dg_canonical_pb_stream_boundary_surf_kern_list
  tensor_stream_boundary_surf_x_kernels[] = {
    // 1x kernels
    {NULL, canonical_pb_boundary_surfx_1x1v_tensor_p1, canonical_pb_boundary_surfx_1x1v_tensor_p2
    }, // 0
    {NULL, canonical_pb_boundary_surfx_1x2v_tensor_p1, canonical_pb_boundary_surfx_1x2v_tensor_p2
    }, // 1
    {NULL, canonical_pb_boundary_surfx_1x3v_tensor_p1, canonical_pb_boundary_surfx_1x3v_tensor_p2
    }, // 2
    // 2x kernels
    {NULL, canonical_pb_boundary_surfx_2x2v_tensor_p1, canonical_pb_boundary_surfx_2x2v_tensor_p2
    }, // 3
...
GKYL_CU_D static const gkyl_dg_canonical_pb_stream_boundary_surf_kern_list
  tensor_stream_boundary_surf_y_kernels[] = {
    ...
    {NULL, NULL, NULL}, // 2
    // 2x kernels
    {NULL, canonical_pb_boundary_surfy_2x2v_tensor_p1, canonical_pb_boundary_surfy_2x2v_tensor_p2
    }, // 3
