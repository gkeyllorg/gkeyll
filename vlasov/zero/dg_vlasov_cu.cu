...
__global__ static void gkyl_vlasov_set_auxfields_cu_kernel(
  const struct gkyl_dg_eqn *eqn, const struct gkyl_array *field, const struct gkyl_array *cot_vec,
...
__global__ static void dg_vlasov_set_cu_dev_ptrs(
  struct dg_vlasov *vlasov, enum gkyl_basis_type b_type, int cv_index, int cdim, int vdim,
  int poly_order, enum gkyl_model_id model_id, enum gkyl_field_id field_id
)
{
