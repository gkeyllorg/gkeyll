...
gkyl_canonical_pb_set_auxfields_cu_kernel(
...
__global__ static void
dg_canonical_pb_set_cu_dev_ptrs(
  struct dg_canonical_pb *canonical_pb, enum gkyl_basis_type b_type, int cv_index, int cdim,
