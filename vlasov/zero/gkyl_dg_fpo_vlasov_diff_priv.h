...
typedef double (*fpo_vlasov_diff_surf_t)(
  const double *w, const double *dx, const double *g[27], const double *f[27],
...
GKYL_CU_D static const gkyl_dg_fpo_vlasov_diff_boundary_surf_kern_list
  ser_boundary_surf_xx_kernels[] = {{NULL, NULL, NULL}, {NULL, NULL, NULL}, {NULL, NULL, NULL}};

// Boundary Surface kernel list: xy-direction
GKYL_CU_D static const gkyl_dg_fpo_vlasov_diff_boundary_surf_kern_list
  ser_boundary_surf_xy_kernels[] = {{NULL, NULL, NULL}, {NULL, NULL, NULL}, {NULL, NULL, NULL}};

// Boundary Surface kernel list: xz-direction
GKYL_CU_D static const gkyl_dg_fpo_vlasov_diff_boundary_surf_kern_list
  ser_boundary_surf_xz_kernels[] = {{NULL, NULL, NULL}, {NULL, NULL, NULL}, {NULL, NULL, NULL}};

// Boundary Surface kernel list: yx-direction
GKYL_CU_D static const gkyl_dg_fpo_vlasov_diff_boundary_surf_kern_list
  ser_boundary_surf_yx_kernels[] = {{NULL, NULL, NULL}, {NULL, NULL, NULL}, {NULL, NULL, NULL}};

// Boundary Surface kernel list: yy-direction
GKYL_CU_D static const gkyl_dg_fpo_vlasov_diff_boundary_surf_kern_list
  ser_boundary_surf_yy_kernels[] = {{NULL, NULL, NULL}, {NULL, NULL, NULL}, {NULL, NULL, NULL}};

// Boundary Surface kernel list: yz-direction
GKYL_CU_D static const gkyl_dg_fpo_vlasov_diff_boundary_surf_kern_list
  ser_boundary_surf_yz_kernels[] = {{NULL, NULL, NULL}, {NULL, NULL, NULL}, {NULL, NULL, NULL}};

// Boundary Surface kernel list: zx-direction
GKYL_CU_D static const gkyl_dg_fpo_vlasov_diff_boundary_surf_kern_list
  ser_boundary_surf_zx_kernels[] = {{NULL, NULL, NULL}, {NULL, NULL, NULL}, {NULL, NULL, NULL}};

// Boundary Surface kernel list: zy-direction
GKYL_CU_D static const gkyl_dg_fpo_vlasov_diff_boundary_surf_kern_list
  ser_boundary_surf_zy_kernels[] = {{NULL, NULL, NULL}, {NULL, NULL, NULL}, {NULL, NULL, NULL}};

// Boundary Surface kernel list: zz-direction
GKYL_CU_D static const gkyl_dg_fpo_vlasov_diff_boundary_surf_kern_list
  ser_boundary_surf_zz_kernels[] = {{NULL, NULL, NULL}, {NULL, NULL, NULL}, {NULL, NULL, NULL}};
