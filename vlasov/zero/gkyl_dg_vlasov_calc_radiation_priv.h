...
typedef void (*calc_radiation_t)(
  const double *w, const double *dv, const double *vmap, double t_cool, double p0,
  double *GKYL_RESTRICT rad
);

// for use in kernel tables
typedef struct {
  calc_radiation_t kernels[4];
} gkyl_dg_calc_radiation_kern_list;

// Compton radiation, rad = -1/t_cool*(p - p0) (Serendipity kernels).
GKYL_CU_D static const gkyl_dg_calc_radiation_kern_list ser_rad_compton_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_calc_radiation_kern_list ser_rad_curvature_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_calc_radiation_kern_list tensor_rad_compton_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_calc_radiation_kern_list tensor_rad_curvature_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static calc_radiation_t
