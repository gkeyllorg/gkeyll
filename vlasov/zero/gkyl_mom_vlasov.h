...
struct gkyl_mom_vlasov_inp {
  ...
  const struct gkyl_array
    *hamil; // Hamiltonian utilized to compute certain moments (such as energy or dH/dv moment).
  double
    v_thresh; // Threshold velocity for moments over a subset of the domain such as M0_UPPER and M0_LOWER.
  double
    f_thresh; // Threshold f for accumulating moments over a subset of the domain such as M0_UPPER and M0_LOWER.
