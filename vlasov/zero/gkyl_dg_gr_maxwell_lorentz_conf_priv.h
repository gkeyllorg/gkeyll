...
typedef void (*dg_gr_maxwell_lorentz_conf_t)(
  const gkyl_dg_gr_maxwell_inp *meq, const double *dx, const double *jacob_pos,
...
typedef struct {
  dg_gr_maxwell_lorentz_conf_t kernels[4];
} gkyl_dg_gr_maxwell_lorentz_conf_kern_list;
...
GKYL_CU_D static const gkyl_dg_gr_maxwell_lorentz_conf_kern_list ser_lorentz_conf_kernels[] = {
...
GKYL_CU_D static const gkyl_dg_gr_maxwell_lorentz_conf_kern_list tensor_lorentz_conf_kernels[] = {
  {NULL, dg_gr_maxwell_lorentz_conf_1x1v_tensor_p1, dg_gr_maxwell_lorentz_conf_1x1v_tensor_p2, NULL
  }, // 0
  {NULL, dg_gr_maxwell_lorentz_conf_1x2v_tensor_p1, dg_gr_maxwell_lorentz_conf_1x2v_tensor_p2, NULL
  }, // 1
  {NULL, dg_gr_maxwell_lorentz_conf_1x3v_tensor_p1, dg_gr_maxwell_lorentz_conf_1x3v_tensor_p2, NULL
  }, // 2
