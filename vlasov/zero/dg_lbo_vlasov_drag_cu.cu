...
gkyl_lbo_vlasov_drag_set_auxfields_cu_kernel(
...
__global__ static void
dg_lbo_vlasov_drag_set_cu_dev_ptrs(
  struct dg_lbo_vlasov_drag *lbo_vlasov_drag, enum gkyl_basis_type b_type, int cv_index, int cdim,
...
struct gkyl_dg_eqn *
gkyl_dg_lbo_vlasov_drag_cu_dev_new(
...
)
{
  ...
  dg_lbo_vlasov_drag_set_cu_dev_ptrs<<<1, 1>>>(
    lbo_vlasov_drag_cu, gkyl_basis_phase_kernel_type(cbasis, pbasis), cv_index[cdim].vdim[vdim],
