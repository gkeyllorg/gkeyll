...
typedef double (*advection_surf_t)(
  const double *w, const double *dx, const double *ul, const double *uc, const double *ur,
...
)
{
  ...
  return advection->surf[dir](
    xcC, dxC, (const double *)gkyl_array_cfetch(advection->auxfields.u_i, cidx_l),
