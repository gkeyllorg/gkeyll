...
typedef double (*fpo_vlasov_drag_surf_t)(
  const double *w, const double *dxv, const double *h, const double *fl, const double *fc,
  const double *fr, double *GKYL_RESTRICT out
);

typedef double (*fpo_vlasov_drag_boundary_surf_t)(
  const double *w, const double *dxv, const double *h, const int edge, const double *fSkin,
