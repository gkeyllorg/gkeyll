...
typedef void (*calc_hamil_t)(
  const double *w, const double *dv, const double *vmap, double *GKYL_RESTRICT hamil,
  double *GKYL_RESTRICT hamil_inv
);

// for use in kernel tables
typedef struct {
  calc_hamil_t kernels[4];
} gkyl_dg_calc_hamil_kern_list;

// Default Hamiltonian = v^2/2 (Serendipity kernels).
GKYL_CU_D static const gkyl_dg_calc_hamil_kern_list ser_hamil_default_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_calc_hamil_kern_list ser_hamil_sr_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_calc_hamil_kern_list tensor_hamil_default_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_calc_hamil_kern_list tensor_hamil_sr_kernels[] = {
  // 1x kernels
