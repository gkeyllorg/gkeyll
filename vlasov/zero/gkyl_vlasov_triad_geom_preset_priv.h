...
static void
eval_vierbein_inv_from_vierbein(
  int vdim, evalf_t eval_vierbein, double t, const double *GKYL_RESTRICT xn,
...
)
{
  ...
  double H = (1.0 / sqrt(1 + 2 * M * r / rho_sq)) *
             (sqrt(1 + pr_hat * pr_hat + pphi_hat * pphi_hat) - (2 * M * r / rho_sq) * pr_hat);

  fout[0] = H;
}

void
eval_ks_rphi_hamil_2x2v(
  double t, const double *GKYL_RESTRICT xn, double *GKYL_RESTRICT fout, void *ctx
)
{
  // Grab the geometry
...
static const hamil_kern_list ks_r_hamil_list[] =
  {{NULL, NULL, NULL}, {NULL, NULL, NULL}, {eval_ks_r_hamil_1x3v, NULL, NULL}};

static const hamil_kern_list ks_rtheta_hamil_list[] =
  {{NULL, NULL, NULL}, {NULL, NULL, NULL}, {NULL, eval_ks_rtheta_hamil_2x3v, eval_ks_hamil_3x3v}};

static const hamil_kern_list ks_hamil_3v_list[] =
  {{NULL, NULL, NULL}, {NULL, NULL, NULL}, {NULL, NULL, eval_ks_hamil_3x3v}};

static const hamil_kern_list ks_hamil_cart_3v_list[] =
  {{NULL, NULL, NULL}, {NULL, NULL, NULL}, {NULL, NULL, eval_ks_hamil_cart_3x3v}};

static const vierbein_kern_list flat_vierbein_list[] =
  {{eval_flat_vierbein_1v}, {eval_flat_vierbein_2v}, {eval_flat_vierbein_3v}};

static const vierbein_kern_list flat_vierbein_inv_list[] =
  {{eval_flat_vierbein_inv_1v}, {eval_flat_vierbein_inv_2v}, {eval_flat_vierbein_inv_3v}};
