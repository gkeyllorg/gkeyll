...
__global__ static void gkyl_dg_diffusion_fluid_set_auxfields_cu_kernel(
...
__global__ void static dg_diffusion_fluid_set_cu_dev_ptrs(
  struct dg_diffusion_fluid *diffusion, enum gkyl_basis_type b_type, int cdim, int poly_order,
  int diff_order, int diffdirs_linidx
)
{
