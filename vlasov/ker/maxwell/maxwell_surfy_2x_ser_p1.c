...
{ 
  ...
  incr_l[1] = c2*((-(0.4330127018922193*bzl[3])-0.25*bzl[1])*jacob_cl_inv+(0.4330127018922193*bzc[3]-0.25*bzc[1])*jacob_cc_inv); 
  incr_l[2] = c2*((0.75*bzl[2]+0.4330127018922193*bzl[0])*jacob_cl_inv+(0.4330127018922193*bzc[0]-0.75*bzc[2])*jacob_cc_inv); 
  incr_l[3] = c2*((0.75*bzl[3]+0.4330127018922193*bzl[1])*jacob_cl_inv+(0.4330127018922193*bzc[1]-0.75*bzc[3])*jacob_cc_inv); 

  incr_r[0] = c2*((0.25*bzr[0]-0.4330127018922193*bzr[2])*jacob_cr_inv+(0.4330127018922193*bzc[2]+0.25*bzc[0])*jacob_cc_inv); 
  incr_r[1] = c2*((0.25*bzr[1]-0.4330127018922193*bzr[3])*jacob_cr_inv+(0.4330127018922193*bzc[3]+0.25*bzc[1])*jacob_cc_inv); 
  incr_r[2] = c2*((0.4330127018922193*bzr[0]-0.75*bzr[2])*jacob_cr_inv+(0.75*bzc[2]+0.4330127018922193*bzc[0])*jacob_cc_inv); 
  incr_r[3] = c2*((0.4330127018922193*bzr[1]-0.75*bzr[3])*jacob_cr_inv+(0.75*bzc[3]+0.4330127018922193*bzc[1])*jacob_cc_inv); 
  ...
  incr_l[1] = c2chi*((0.4330127018922193*phl[3]+0.25*phl[1])*jacob_cl_inv+(0.25*phc[1]-0.4330127018922193*phc[3])*jacob_cc_inv); 
  incr_l[2] = c2chi*((-(0.75*phl[2])-0.4330127018922193*phl[0])*jacob_cl_inv+(0.75*phc[2]-0.4330127018922193*phc[0])*jacob_cc_inv); 
  incr_l[3] = c2chi*((-(0.75*phl[3])-0.4330127018922193*phl[1])*jacob_cl_inv+(0.75*phc[3]-0.4330127018922193*phc[1])*jacob_cc_inv); 

  incr_r[0] = c2chi*((0.4330127018922193*phr[2]-0.25*phr[0])*jacob_cr_inv+(-(0.4330127018922193*phc[2])-0.25*phc[0])*jacob_cc_inv); 
  incr_r[1] = c2chi*((0.4330127018922193*phr[3]-0.25*phr[1])*jacob_cr_inv+(-(0.4330127018922193*phc[3])-0.25*phc[1])*jacob_cc_inv); 
  incr_r[2] = c2chi*((0.75*phr[2]-0.4330127018922193*phr[0])*jacob_cr_inv+(-(0.75*phc[2])-0.4330127018922193*phc[0])*jacob_cc_inv); 
  incr_r[3] = c2chi*((0.75*phr[3]-0.4330127018922193*phr[1])*jacob_cr_inv+(-(0.75*phc[3])-0.4330127018922193*phc[1])*jacob_cc_inv); 
  ...
  incr_l[1] = c2*((0.4330127018922193*bxl[3]+0.25*bxl[1])*jacob_cl_inv+(0.25*bxc[1]-0.4330127018922193*bxc[3])*jacob_cc_inv); 
  incr_l[2] = c2*((-(0.75*bxl[2])-0.4330127018922193*bxl[0])*jacob_cl_inv+(0.75*bxc[2]-0.4330127018922193*bxc[0])*jacob_cc_inv); 
  incr_l[3] = c2*((-(0.75*bxl[3])-0.4330127018922193*bxl[1])*jacob_cl_inv+(0.75*bxc[3]-0.4330127018922193*bxc[1])*jacob_cc_inv); 

  incr_r[0] = c2*((0.4330127018922193*bxr[2]-0.25*bxr[0])*jacob_cr_inv+(-(0.4330127018922193*bxc[2])-0.25*bxc[0])*jacob_cc_inv); 
  incr_r[1] = c2*((0.4330127018922193*bxr[3]-0.25*bxr[1])*jacob_cr_inv+(-(0.4330127018922193*bxc[3])-0.25*bxc[1])*jacob_cc_inv); 
  incr_r[2] = c2*((0.75*bxr[2]-0.4330127018922193*bxr[0])*jacob_cr_inv+(-(0.75*bxc[2])-0.4330127018922193*bxc[0])*jacob_cc_inv); 
  incr_r[3] = c2*((0.75*bxr[3]-0.4330127018922193*bxr[1])*jacob_cr_inv+(-(0.75*bxc[3])-0.4330127018922193*bxc[1])*jacob_cc_inv); 
  ...
  incr_l[1] = (0.4330127018922193*ezl[3]+0.25*ezl[1])*jacob_cl_inv+(0.25*ezc[1]-0.4330127018922193*ezc[3])*jacob_cc_inv; 
  incr_l[2] = (-(0.75*ezl[2])-0.4330127018922193*ezl[0])*jacob_cl_inv+(0.75*ezc[2]-0.4330127018922193*ezc[0])*jacob_cc_inv; 
  incr_l[3] = (-(0.75*ezl[3])-0.4330127018922193*ezl[1])*jacob_cl_inv+(0.75*ezc[3]-0.4330127018922193*ezc[1])*jacob_cc_inv; 

  incr_r[0] = (0.4330127018922193*ezr[2]-0.25*ezr[0])*jacob_cr_inv+(-(0.4330127018922193*ezc[2])-0.25*ezc[0])*jacob_cc_inv; 
  incr_r[1] = (0.4330127018922193*ezr[3]-0.25*ezr[1])*jacob_cr_inv+(-(0.4330127018922193*ezc[3])-0.25*ezc[1])*jacob_cc_inv; 
  incr_r[2] = (0.75*ezr[2]-0.4330127018922193*ezr[0])*jacob_cr_inv+(-(0.75*ezc[2])-0.4330127018922193*ezc[0])*jacob_cc_inv; 
  incr_r[3] = (0.75*ezr[3]-0.4330127018922193*ezr[1])*jacob_cr_inv+(-(0.75*ezc[3])-0.4330127018922193*ezc[1])*jacob_cc_inv; 
  ...
  incr_l[1] = ((0.4330127018922193*psl[3]+0.25*psl[1])*jacob_cl_inv+(0.25*psc[1]-0.4330127018922193*psc[3])*jacob_cc_inv)*gamma; 
  incr_l[2] = ((-(0.75*psl[2])-0.4330127018922193*psl[0])*jacob_cl_inv+(0.75*psc[2]-0.4330127018922193*psc[0])*jacob_cc_inv)*gamma; 
  incr_l[3] = ((-(0.75*psl[3])-0.4330127018922193*psl[1])*jacob_cl_inv+(0.75*psc[3]-0.4330127018922193*psc[1])*jacob_cc_inv)*gamma; 

  incr_r[0] = ((0.4330127018922193*psr[2]-0.25*psr[0])*jacob_cr_inv+(-(0.4330127018922193*psc[2])-0.25*psc[0])*jacob_cc_inv)*gamma; 
  incr_r[1] = ((0.4330127018922193*psr[3]-0.25*psr[1])*jacob_cr_inv+(-(0.4330127018922193*psc[3])-0.25*psc[1])*jacob_cc_inv)*gamma; 
  incr_r[2] = ((0.75*psr[2]-0.4330127018922193*psr[0])*jacob_cr_inv+(-(0.75*psc[2])-0.4330127018922193*psc[0])*jacob_cc_inv)*gamma; 
  incr_r[3] = ((0.75*psr[3]-0.4330127018922193*psr[1])*jacob_cr_inv+(-(0.75*psc[3])-0.4330127018922193*psc[1])*jacob_cc_inv)*gamma; 
  ...
  incr_l[1] = (-(0.4330127018922193*exl[3])-0.25*exl[1])*jacob_cl_inv+(0.4330127018922193*exc[3]-0.25*exc[1])*jacob_cc_inv; 
  incr_l[2] = (0.75*exl[2]+0.4330127018922193*exl[0])*jacob_cl_inv+(0.4330127018922193*exc[0]-0.75*exc[2])*jacob_cc_inv; 
  incr_l[3] = (0.75*exl[3]+0.4330127018922193*exl[1])*jacob_cl_inv+(0.4330127018922193*exc[1]-0.75*exc[3])*jacob_cc_inv; 

  incr_r[0] = (0.25*exr[0]-0.4330127018922193*exr[2])*jacob_cr_inv+(0.4330127018922193*exc[2]+0.25*exc[0])*jacob_cc_inv; 
  incr_r[1] = (0.25*exr[1]-0.4330127018922193*exr[3])*jacob_cr_inv+(0.4330127018922193*exc[3]+0.25*exc[1])*jacob_cc_inv; 
  incr_r[2] = (0.4330127018922193*exr[0]-0.75*exr[2])*jacob_cr_inv+(0.75*exc[2]+0.4330127018922193*exc[0])*jacob_cc_inv; 
  incr_r[3] = (0.4330127018922193*exr[1]-0.75*exr[3])*jacob_cr_inv+(0.75*exc[3]+0.4330127018922193*exc[1])*jacob_cc_inv; 
  ...
  incr_l[1] = chi*((0.4330127018922193*eyl[3]+0.25*eyl[1])*jacob_cl_inv+(0.25*eyc[1]-0.4330127018922193*eyc[3])*jacob_cc_inv); 
  incr_l[2] = chi*((-(0.75*eyl[2])-0.4330127018922193*eyl[0])*jacob_cl_inv+(0.75*eyc[2]-0.4330127018922193*eyc[0])*jacob_cc_inv); 
  incr_l[3] = chi*((-(0.75*eyl[3])-0.4330127018922193*eyl[1])*jacob_cl_inv+(0.75*eyc[3]-0.4330127018922193*eyc[1])*jacob_cc_inv); 

  incr_r[0] = chi*((0.4330127018922193*eyr[2]-0.25*eyr[0])*jacob_cr_inv+(-(0.4330127018922193*eyc[2])-0.25*eyc[0])*jacob_cc_inv); 
  incr_r[1] = chi*((0.4330127018922193*eyr[3]-0.25*eyr[1])*jacob_cr_inv+(-(0.4330127018922193*eyc[3])-0.25*eyc[1])*jacob_cc_inv); 
  incr_r[2] = chi*((0.75*eyr[2]-0.4330127018922193*eyr[0])*jacob_cr_inv+(-(0.75*eyc[2])-0.4330127018922193*eyc[0])*jacob_cc_inv); 
  incr_r[3] = chi*((0.75*eyr[3]-0.4330127018922193*eyr[1])*jacob_cr_inv+(-(0.75*eyc[3])-0.4330127018922193*eyc[1])*jacob_cc_inv); 
  ...
  incr_l[1] = c2gamma*((0.4330127018922193*byl[3]+0.25*byl[1])*jacob_cl_inv+(0.25*byc[1]-0.4330127018922193*byc[3])*jacob_cc_inv); 
  incr_l[2] = c2gamma*((-(0.75*byl[2])-0.4330127018922193*byl[0])*jacob_cl_inv+(0.75*byc[2]-0.4330127018922193*byc[0])*jacob_cc_inv); 
  incr_l[3] = c2gamma*((-(0.75*byl[3])-0.4330127018922193*byl[1])*jacob_cl_inv+(0.75*byc[3]-0.4330127018922193*byc[1])*jacob_cc_inv); 

  incr_r[0] = c2gamma*((0.4330127018922193*byr[2]-0.25*byr[0])*jacob_cr_inv+(-(0.4330127018922193*byc[2])-0.25*byc[0])*jacob_cc_inv); 
  incr_r[1] = c2gamma*((0.4330127018922193*byr[3]-0.25*byr[1])*jacob_cr_inv+(-(0.4330127018922193*byc[3])-0.25*byc[1])*jacob_cc_inv); 
  incr_r[2] = c2gamma*((0.75*byr[2]-0.4330127018922193*byr[0])*jacob_cr_inv+(-(0.75*byc[2])-0.4330127018922193*byc[0])*jacob_cc_inv); 
  incr_r[3] = c2gamma*((0.75*byr[3]-0.4330127018922193*byr[1])*jacob_cr_inv+(-(0.75*byc[3])-0.4330127018922193*byc[1])*jacob_cc_inv); 
