...
GKYL_CU_DH void fpo_diff_coeff_diag_1x3v_vz_ser_p2_upvz(const double *dxv, const double *gamma, const double* fpo_g_stencil[3], const double* fpo_d2gdv2_surf, double *diff_coeff) {
  ...
  out[14] = -(1.3453125*(G_L[14]*dv1_sq*gamma_avg+G_C[14]*dv1_sq*gamma_avg))-1.228461905125165*G_L[4]*dv1_sq*gamma_avg-0.8048543516337288*G_C[4]*dv1_sq*gamma_avg-0.5869678440936947*G_L[0]*dv1_sq*gamma_avg+0.5869678440936947*G_C[0]*dv1_sq*gamma_avg+0.22135943621178647*d2G_surf_C[0]*gamma_avg; 
  ...
  out[28] = -(1.3453125*(G_L[28]*dv1_sq*gamma_avg+G_C[28]*dv1_sq*gamma_avg))-1.228461905125165*G_L[8]*dv1_sq*gamma_avg-0.8048543516337289*G_C[8]*dv1_sq*gamma_avg-0.5869678440936947*G_L[1]*dv1_sq*gamma_avg+0.5869678440936947*G_C[1]*dv1_sq*gamma_avg+0.22135943621178653*d2G_surf_C[1]*gamma_avg; 
  out[29] = -(1.3453125*(G_L[29]*dv1_sq*gamma_avg+G_C[29]*dv1_sq*gamma_avg))-1.228461905125165*G_L[9]*dv1_sq*gamma_avg-0.8048543516337289*G_C[9]*dv1_sq*gamma_avg-0.5869678440936947*G_L[2]*dv1_sq*gamma_avg+0.5869678440936947*G_C[2]*dv1_sq*gamma_avg+0.22135943621178653*d2G_surf_C[2]*gamma_avg; 
  out[30] = -(1.3453125*(G_L[30]*dv1_sq*gamma_avg+G_C[30]*dv1_sq*gamma_avg))-1.228461905125165*G_L[10]*dv1_sq*gamma_avg-0.8048543516337289*G_C[10]*dv1_sq*gamma_avg-0.5869678440936947*G_L[3]*dv1_sq*gamma_avg+0.5869678440936947*G_C[3]*dv1_sq*gamma_avg+0.22135943621178653*d2G_surf_C[3]*gamma_avg; 
  ...
  out[41] = -(1.3453125*(G_L[41]*dv1_sq*gamma_avg+G_C[41]*dv1_sq*gamma_avg))-1.228461905125165*G_L[16]*dv1_sq*gamma_avg-0.8048543516337288*G_C[16]*dv1_sq*gamma_avg-0.5869678440936947*G_L[5]*dv1_sq*gamma_avg+0.5869678440936947*G_C[5]*dv1_sq*gamma_avg+0.22135943621178647*d2G_surf_C[4]*gamma_avg; 
  out[42] = -(1.3453125*(G_L[42]*dv1_sq*gamma_avg+G_C[42]*dv1_sq*gamma_avg))-1.228461905125165*G_L[17]*dv1_sq*gamma_avg-0.8048543516337288*G_C[17]*dv1_sq*gamma_avg-0.5869678440936947*G_L[6]*dv1_sq*gamma_avg+0.5869678440936947*G_C[6]*dv1_sq*gamma_avg+0.22135943621178647*d2G_surf_C[5]*gamma_avg; 
  out[43] = -(1.3453125*(G_L[43]*dv1_sq*gamma_avg+G_C[43]*dv1_sq*gamma_avg))-1.228461905125165*G_L[18]*dv1_sq*gamma_avg-0.8048543516337288*G_C[18]*dv1_sq*gamma_avg-0.5869678440936947*G_L[7]*dv1_sq*gamma_avg+0.5869678440936947*G_C[7]*dv1_sq*gamma_avg+0.22135943621178647*d2G_surf_C[6]*gamma_avg; 
  ...
  out[47] = -(1.3453125*(G_L[47]*dv1_sq*gamma_avg+G_C[47]*dv1_sq*gamma_avg))-1.228461905125165*G_L[31]*dv1_sq*gamma_avg-0.8048543516337289*G_C[31]*dv1_sq*gamma_avg-0.5869678440936947*G_L[15]*dv1_sq*gamma_avg+0.5869678440936947*G_C[15]*dv1_sq*gamma_avg+0.22135943621178653*d2G_surf_C[10]*gamma_avg; 
} 
