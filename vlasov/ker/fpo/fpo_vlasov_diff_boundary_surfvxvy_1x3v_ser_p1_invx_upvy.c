...
GKYL_CU_DH double fpo_vlasov_diff_boundary_surfvxvy_1x3v_ser_p1_invx_upvy(const double *dxv, const double *diff_coeff_C,
  ...
  f_rec_up[0] = 1.224744871391589*fCC[3]+0.7071067811865475*fCC[0]; 
  f_rec_up[1] = 1.224744871391589*fCC[6]+0.7071067811865475*fCC[1]; 
  f_rec_up[2] = 1.224744871391589*fCC[7]+0.7071067811865475*fCC[2]; 
  f_rec_up[3] = 1.224744871391589*fCC[10]+0.7071067811865475*fCC[4]; 
  f_rec_up[4] = 1.224744871391589*fCC[11]+0.7071067811865475*fCC[5]; 
  f_rec_up[5] = 1.224744871391589*fCC[13]+0.7071067811865475*fCC[8]; 
  f_rec_up[6] = 1.224744871391589*fCC[14]+0.7071067811865475*fCC[9]; 
  f_rec_up[7] = 1.224744871391589*fCC[15]+0.7071067811865475*fCC[12]; 
