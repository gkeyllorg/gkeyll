...
GKYL_CU_DH double fpo_vlasov_diff_boundary_surfvzvx_1x3v_ser_p1_invz_upvx(const double *dxv, const double *diff_coeff_C,
  ...
  f_rec_up[0] = 1.224744871391589*fCC[2]+0.7071067811865475*fCC[0]; 
  f_rec_up[1] = 1.224744871391589*fCC[5]+0.7071067811865475*fCC[1]; 
  f_rec_up[2] = 1.224744871391589*fCC[7]+0.7071067811865475*fCC[3]; 
  f_rec_up[3] = 1.224744871391589*fCC[9]+0.7071067811865475*fCC[4]; 
  f_rec_up[4] = 1.224744871391589*fCC[11]+0.7071067811865475*fCC[6]; 
  f_rec_up[5] = 1.224744871391589*fCC[12]+0.7071067811865475*fCC[8]; 
  f_rec_up[6] = 1.224744871391589*fCC[14]+0.7071067811865475*fCC[10]; 
  f_rec_up[7] = 1.224744871391589*fCC[15]+0.7071067811865475*fCC[13]; 

  df_rec_lo[0] = -(0.7071067811865475*fCC[9])+0.7071067811865475*fBC[9]+0.6123724356957944*(fCC[2]+fBC[2]); 
  df_rec_lo[1] = -(0.7071067811865475*fCC[12])+0.7071067811865475*fBC[12]+0.6123724356957944*(fCC[5]+fBC[5]); 
  df_rec_lo[3] = -(0.7071067811865475*fCC[14])+0.7071067811865475*fBC[14]+0.6123724356957944*(fCC[7]+fBC[7]); 
  df_rec_lo[5] = -(0.7071067811865475*fCC[15])+0.7071067811865475*fBC[15]+0.6123724356957944*(fCC[11]+fBC[11]); 
  df_rec_up[0] = -(0.7071067811865475*fTC[9])+0.7071067811865475*fCC[9]+0.6123724356957944*(fTC[2]+fCC[2]); 
  df_rec_up[1] = -(0.7071067811865475*fTC[12])+0.7071067811865475*fCC[12]+0.6123724356957944*(fTC[5]+fCC[5]); 
  df_rec_up[3] = -(0.7071067811865475*fTC[14])+0.7071067811865475*fCC[14]+0.6123724356957944*(fTC[7]+fCC[7]); 
  df_rec_up[5] = -(0.7071067811865475*fTC[15])+0.7071067811865475*fCC[15]+0.6123724356957944*(fTC[11]+fCC[11]); 
