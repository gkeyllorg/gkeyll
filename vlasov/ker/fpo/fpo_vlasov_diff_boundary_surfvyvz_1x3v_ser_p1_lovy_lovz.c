...
GKYL_CU_DH double fpo_vlasov_diff_boundary_surfvyvz_1x3v_ser_p1_lovy_lovz(const double *dxv, const double *diff_coeff_C,
  ...
  df_rec_up[0] = -(0.7071067811865475*fCR[10])+0.7071067811865475*fCC[10]+0.6123724356957944*(fCR[4]+fCC[4]); 
  df_rec_up[1] = -(0.7071067811865475*fCR[13])+0.7071067811865475*fCC[13]+0.6123724356957944*(fCR[8]+fCC[8]); 
  df_rec_up[2] = -(0.7071067811865475*fCR[14])+0.7071067811865475*fCC[14]+0.6123724356957944*(fCR[9]+fCC[9]); 
  df_rec_up[4] = -(0.7071067811865475*fCR[15])+0.7071067811865475*fCC[15]+0.6123724356957944*(fCR[12]+fCC[12]); 
  ...
  double cflFreq = fabs(Dsurf_CR_vy[0]); 
