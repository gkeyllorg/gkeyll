...
GKYL_CU_DH void fpo_diff_coeff_diag_1x3v_vz_ser_p2_lovz(const double *dxv, const double *gamma, const double* fpo_g_stencil[3], const double* fpo_d2gdv2_surf, double *diff_coeff) {
  ...
  out[14] = -(1.3453125*(G_R[14]*dv1_sq*gamma_avg+G_C[14]*dv1_sq*gamma_avg))+1.228461905125165*G_R[4]*dv1_sq*gamma_avg+0.8048543516337288*G_C[4]*dv1_sq*gamma_avg-0.5869678440936947*G_R[0]*dv1_sq*gamma_avg+0.5869678440936947*G_C[0]*dv1_sq*gamma_avg+0.22135943621178647*d2G_surf_C[0]*gamma_avg; 
  ...
  out[28] = -(1.3453125*(G_R[28]*dv1_sq*gamma_avg+G_C[28]*dv1_sq*gamma_avg))+1.228461905125165*G_R[8]*dv1_sq*gamma_avg+0.8048543516337289*G_C[8]*dv1_sq*gamma_avg-0.5869678440936947*G_R[1]*dv1_sq*gamma_avg+0.5869678440936947*G_C[1]*dv1_sq*gamma_avg+0.22135943621178653*d2G_surf_C[1]*gamma_avg; 
  out[29] = -(1.3453125*(G_R[29]*dv1_sq*gamma_avg+G_C[29]*dv1_sq*gamma_avg))+1.228461905125165*G_R[9]*dv1_sq*gamma_avg+0.8048543516337289*G_C[9]*dv1_sq*gamma_avg-0.5869678440936947*G_R[2]*dv1_sq*gamma_avg+0.5869678440936947*G_C[2]*dv1_sq*gamma_avg+0.22135943621178653*d2G_surf_C[2]*gamma_avg; 
  out[30] = -(1.3453125*(G_R[30]*dv1_sq*gamma_avg+G_C[30]*dv1_sq*gamma_avg))+1.228461905125165*G_R[10]*dv1_sq*gamma_avg+0.8048543516337289*G_C[10]*dv1_sq*gamma_avg-0.5869678440936947*G_R[3]*dv1_sq*gamma_avg+0.5869678440936947*G_C[3]*dv1_sq*gamma_avg+0.22135943621178653*d2G_surf_C[3]*gamma_avg; 
  ...
  out[41] = -(1.3453125*(G_R[41]*dv1_sq*gamma_avg+G_C[41]*dv1_sq*gamma_avg))+1.228461905125165*G_R[16]*dv1_sq*gamma_avg+0.8048543516337288*G_C[16]*dv1_sq*gamma_avg-0.5869678440936947*G_R[5]*dv1_sq*gamma_avg+0.5869678440936947*G_C[5]*dv1_sq*gamma_avg+0.22135943621178647*d2G_surf_C[4]*gamma_avg; 
  out[42] = -(1.3453125*(G_R[42]*dv1_sq*gamma_avg+G_C[42]*dv1_sq*gamma_avg))+1.228461905125165*G_R[17]*dv1_sq*gamma_avg+0.8048543516337288*G_C[17]*dv1_sq*gamma_avg-0.5869678440936947*G_R[6]*dv1_sq*gamma_avg+0.5869678440936947*G_C[6]*dv1_sq*gamma_avg+0.22135943621178647*d2G_surf_C[5]*gamma_avg; 
  out[43] = -(1.3453125*(G_R[43]*dv1_sq*gamma_avg+G_C[43]*dv1_sq*gamma_avg))+1.228461905125165*G_R[18]*dv1_sq*gamma_avg+0.8048543516337288*G_C[18]*dv1_sq*gamma_avg-0.5869678440936947*G_R[7]*dv1_sq*gamma_avg+0.5869678440936947*G_C[7]*dv1_sq*gamma_avg+0.22135943621178647*d2G_surf_C[6]*gamma_avg; 
  ...
  out[47] = -(1.3453125*(G_R[47]*dv1_sq*gamma_avg+G_C[47]*dv1_sq*gamma_avg))+1.228461905125165*G_R[31]*dv1_sq*gamma_avg+0.8048543516337289*G_C[31]*dv1_sq*gamma_avg-0.5869678440936947*G_R[15]*dv1_sq*gamma_avg+0.5869678440936947*G_C[15]*dv1_sq*gamma_avg+0.22135943621178653*d2G_surf_C[10]*gamma_avg; 
} 
