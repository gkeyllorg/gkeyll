...
GKYL_CU_DH double fpo_vlasov_diff_surfvzvy_1x3v_ser_p1(const double* dxv, const double* diff_coeff_C, 
  ...
  df_rec_lo[0] = 0.11785113019775789*(fCR[10]+fCL[10])-0.2357022603955158*fCC[10]-0.11785113019775789*(fBR[10]+fBL[10])+0.2357022603955158*fBC[10]-0.10206207261596573*(fCR[4]+fBL[4]+fCR[3]+fCL[3]+fBR[3]+fBL[3])+0.10206207261596573*(fCL[4]+fBR[4])+0.20412414523193148*(fCC[3]+fBC[3])+0.0883883476483184*(fCR[0]+fBR[0])-0.0883883476483184*(fCL[0]+fBL[0]); 
  df_rec_lo[1] = 0.11785113019775789*(fCR[13]+fCL[13])-0.2357022603955158*fCC[13]-0.11785113019775789*(fBR[13]+fBL[13])+0.2357022603955158*fBC[13]-0.10206207261596573*(fCR[8]+fBL[8]+fCR[6]+fCL[6]+fBR[6]+fBL[6])+0.10206207261596573*(fCL[8]+fBR[8])+0.20412414523193148*(fCC[6]+fBC[6])+0.0883883476483184*(fCR[1]+fBR[1])-0.0883883476483184*(fCL[1]+fBL[1]); 
  df_rec_lo[2] = 0.11785113019775789*(fCR[14]+fCL[14])-0.2357022603955158*fCC[14]-0.11785113019775789*(fBR[14]+fBL[14])+0.2357022603955158*fBC[14]-0.10206207261596573*(fCR[9]+fBL[9]+fCR[7]+fCL[7]+fBR[7]+fBL[7])+0.10206207261596573*(fCL[9]+fBR[9])+0.20412414523193148*(fCC[7]+fBC[7])+0.0883883476483184*(fCR[2]+fBR[2])-0.0883883476483184*(fCL[2]+fBL[2]); 
  df_rec_lo[3] = 0.20412414523193148*(fCR[10]+fBL[10])-0.20412414523193148*(fCL[10]+fBR[10])-0.1767766952966368*(fCR[4]+fCL[4]+fCR[3]+fBR[3])+0.3535533905932737*fCC[4]+0.1767766952966368*(fBR[4]+fBL[4]+fCL[3]+fBL[3])-0.3535533905932737*fBC[4]+0.15309310892394856*(fCR[0]+fCL[0]+fBR[0]+fBL[0])-0.3061862178478971*(fCC[0]+fBC[0]); 
  df_rec_lo[4] = 0.11785113019775789*(fCR[15]+fCL[15])-0.2357022603955158*fCC[15]-0.11785113019775789*(fBR[15]+fBL[15])+0.2357022603955158*fBC[15]-0.10206207261596573*(fCR[12]+fBL[12]+fCR[11]+fCL[11]+fBR[11]+fBL[11])+0.10206207261596573*(fCL[12]+fBR[12])+0.20412414523193148*(fCC[11]+fBC[11])+0.0883883476483184*(fCR[5]+fBR[5])-0.0883883476483184*(fCL[5]+fBL[5]); 
  df_rec_lo[5] = 0.20412414523193148*(fCR[13]+fBL[13])-0.20412414523193148*(fCL[13]+fBR[13])-0.1767766952966368*(fCR[8]+fCL[8]+fCR[6]+fBR[6])+0.3535533905932737*fCC[8]+0.1767766952966368*(fBR[8]+fBL[8]+fCL[6]+fBL[6])-0.3535533905932737*fBC[8]+0.15309310892394856*(fCR[1]+fCL[1]+fBR[1]+fBL[1])-0.3061862178478971*(fCC[1]+fBC[1]); 
  df_rec_lo[6] = 0.20412414523193148*(fCR[14]+fBL[14])-0.20412414523193148*(fCL[14]+fBR[14])-0.1767766952966368*(fCR[9]+fCL[9]+fCR[7]+fBR[7])+0.3535533905932737*fCC[9]+0.1767766952966368*(fBR[9]+fBL[9]+fCL[7]+fBL[7])-0.3535533905932737*fBC[9]+0.15309310892394856*(fCR[2]+fCL[2]+fBR[2]+fBL[2])-0.3061862178478971*(fCC[2]+fBC[2]); 
  df_rec_lo[7] = 0.20412414523193148*(fCR[15]+fBL[15])-0.20412414523193148*(fCL[15]+fBR[15])-0.1767766952966368*(fCR[12]+fCL[12]+fCR[11]+fBR[11])+0.3535533905932737*fCC[12]+0.1767766952966368*(fBR[12]+fBL[12]+fCL[11]+fBL[11])-0.3535533905932737*fBC[12]+0.15309310892394856*(fCR[5]+fCL[5]+fBR[5]+fBL[5])-0.3061862178478971*(fCC[5]+fBC[5]); 
