...
GKYL_CU_DH double fpo_vlasov_diff_boundary_surfvzvy_1x3v_ser_p1_invz_lovy(const double *dxv, const double *diff_coeff_C,
  ...
  df_rec_lo[0] = -(0.7071067811865475*fCC[10])+0.7071067811865475*fBC[10]+0.6123724356957944*(fCC[3]+fBC[3]); 
  df_rec_lo[1] = -(0.7071067811865475*fCC[13])+0.7071067811865475*fBC[13]+0.6123724356957944*(fCC[6]+fBC[6]); 
  df_rec_lo[2] = -(0.7071067811865475*fCC[14])+0.7071067811865475*fBC[14]+0.6123724356957944*(fCC[7]+fBC[7]); 
  df_rec_lo[4] = -(0.7071067811865475*fCC[15])+0.7071067811865475*fBC[15]+0.6123724356957944*(fCC[11]+fBC[11]); 
  df_rec_up[0] = -(0.7071067811865475*fTC[10])+0.7071067811865475*fCC[10]+0.6123724356957944*(fTC[3]+fCC[3]); 
  df_rec_up[1] = -(0.7071067811865475*fTC[13])+0.7071067811865475*fCC[13]+0.6123724356957944*(fTC[6]+fCC[6]); 
  df_rec_up[2] = -(0.7071067811865475*fTC[14])+0.7071067811865475*fCC[14]+0.6123724356957944*(fTC[7]+fCC[7]); 
  df_rec_up[4] = -(0.7071067811865475*fTC[15])+0.7071067811865475*fCC[15]+0.6123724356957944*(fTC[11]+fCC[11]); 
