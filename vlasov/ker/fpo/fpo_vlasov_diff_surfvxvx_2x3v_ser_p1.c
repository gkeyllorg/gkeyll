...
GKYL_CU_DH double fpo_vlasov_diff_surfvxvx_2x3v_ser_p1(const double* dxv, const double* diff_coeff_C, 
  ...
  f_rec_lo[1] = 0.408248290463863*fL[7]-0.408248290463863*fC[7]+0.3535533905932737*(fL[1]+fC[1]); 
  f_rec_lo[2] = 0.408248290463863*fL[8]-0.408248290463863*fC[8]+0.3535533905932737*(fL[2]+fC[2]); 
  f_rec_lo[3] = 0.408248290463863*fL[11]-0.408248290463863*fC[11]+0.3535533905932737*(fL[4]+fC[4]); 
  f_rec_lo[4] = 0.408248290463863*fL[14]-0.408248290463863*fC[14]+0.3535533905932737*(fL[5]+fC[5]); 
  f_rec_lo[5] = 0.408248290463863*fL[16]-0.408248290463863*fC[16]+0.3535533905932737*(fL[6]+fC[6]); 
  f_rec_lo[6] = 0.408248290463863*fL[18]-0.408248290463863*fC[18]+0.3535533905932737*(fL[9]+fC[9]); 
  f_rec_lo[7] = 0.408248290463863*fL[19]-0.408248290463863*fC[19]+0.3535533905932737*(fL[10]+fC[10]); 
  f_rec_lo[8] = 0.408248290463863*fL[21]-0.408248290463863*fC[21]+0.3535533905932737*(fL[12]+fC[12]); 
  f_rec_lo[9] = 0.408248290463863*fL[22]-0.408248290463863*fC[22]+0.3535533905932737*(fL[13]+fC[13]); 
  f_rec_lo[10] = 0.408248290463863*fL[25]-0.408248290463863*fC[25]+0.3535533905932737*(fL[15]+fC[15]); 
  f_rec_lo[11] = 0.408248290463863*fL[26]-0.408248290463863*fC[26]+0.3535533905932737*(fL[17]+fC[17]); 
  f_rec_lo[12] = 0.408248290463863*fL[27]-0.408248290463863*fC[27]+0.3535533905932737*(fL[20]+fC[20]); 
  f_rec_lo[13] = 0.408248290463863*fL[29]-0.408248290463863*fC[29]+0.3535533905932737*(fL[23]+fC[23]); 
  f_rec_lo[14] = 0.408248290463863*fL[30]-0.408248290463863*fC[30]+0.3535533905932737*(fL[24]+fC[24]); 
  f_rec_lo[15] = 0.408248290463863*fL[31]-0.408248290463863*fC[31]+0.3535533905932737*(fL[28]+fC[28]); 
  f_rec_up[0] = -(0.408248290463863*fR[3])+0.408248290463863*fC[3]+0.3535533905932737*(fR[0]+fC[0]); 
  f_rec_up[1] = -(0.408248290463863*fR[7])+0.408248290463863*fC[7]+0.3535533905932737*(fR[1]+fC[1]); 
  f_rec_up[2] = -(0.408248290463863*fR[8])+0.408248290463863*fC[8]+0.3535533905932737*(fR[2]+fC[2]); 
  f_rec_up[3] = -(0.408248290463863*fR[11])+0.408248290463863*fC[11]+0.3535533905932737*(fR[4]+fC[4]); 
  f_rec_up[4] = -(0.408248290463863*fR[14])+0.408248290463863*fC[14]+0.3535533905932737*(fR[5]+fC[5]); 
  f_rec_up[5] = -(0.408248290463863*fR[16])+0.408248290463863*fC[16]+0.3535533905932737*(fR[6]+fC[6]); 
  f_rec_up[6] = -(0.408248290463863*fR[18])+0.408248290463863*fC[18]+0.3535533905932737*(fR[9]+fC[9]); 
  f_rec_up[7] = -(0.408248290463863*fR[19])+0.408248290463863*fC[19]+0.3535533905932737*(fR[10]+fC[10]); 
  f_rec_up[8] = -(0.408248290463863*fR[21])+0.408248290463863*fC[21]+0.3535533905932737*(fR[12]+fC[12]); 
  f_rec_up[9] = -(0.408248290463863*fR[22])+0.408248290463863*fC[22]+0.3535533905932737*(fR[13]+fC[13]); 
  f_rec_up[10] = -(0.408248290463863*fR[25])+0.408248290463863*fC[25]+0.3535533905932737*(fR[15]+fC[15]); 
  f_rec_up[11] = -(0.408248290463863*fR[26])+0.408248290463863*fC[26]+0.3535533905932737*(fR[17]+fC[17]); 
  f_rec_up[12] = -(0.408248290463863*fR[27])+0.408248290463863*fC[27]+0.3535533905932737*(fR[20]+fC[20]); 
  f_rec_up[13] = -(0.408248290463863*fR[29])+0.408248290463863*fC[29]+0.3535533905932737*(fR[23]+fC[23]); 
  f_rec_up[14] = -(0.408248290463863*fR[30])+0.408248290463863*fC[30]+0.3535533905932737*(fR[24]+fC[24]); 
  f_rec_up[15] = -(0.408248290463863*fR[31])+0.408248290463863*fC[31]+0.3535533905932737*(fR[28]+fC[28]); 

  df_rec_lo[0] = -(0.7654655446197428*(fL[3]+fC[3]))-0.7954951288348656*fL[0]+0.7954951288348656*fC[0]; 
  df_rec_lo[1] = -(0.7654655446197428*(fL[7]+fC[7]))-0.7954951288348656*fL[1]+0.7954951288348656*fC[1]; 
  df_rec_lo[2] = -(0.7654655446197428*(fL[8]+fC[8]))-0.7954951288348656*fL[2]+0.7954951288348656*fC[2]; 
  df_rec_lo[3] = -(0.7654655446197428*(fL[11]+fC[11]))-0.7954951288348656*fL[4]+0.7954951288348656*fC[4]; 
  df_rec_lo[4] = -(0.7654655446197428*(fL[14]+fC[14]))-0.7954951288348656*fL[5]+0.7954951288348656*fC[5]; 
  df_rec_lo[5] = -(0.7654655446197428*(fL[16]+fC[16]))-0.7954951288348656*fL[6]+0.7954951288348656*fC[6]; 
  df_rec_lo[6] = -(0.7654655446197428*(fL[18]+fC[18]))-0.7954951288348656*fL[9]+0.7954951288348656*fC[9]; 
  df_rec_lo[7] = -(0.7654655446197428*(fL[19]+fC[19]))-0.7954951288348656*fL[10]+0.7954951288348656*fC[10]; 
  df_rec_lo[8] = -(0.7654655446197428*(fL[21]+fC[21]))-0.7954951288348656*fL[12]+0.7954951288348656*fC[12]; 
  df_rec_lo[9] = -(0.7654655446197428*(fL[22]+fC[22]))-0.7954951288348656*fL[13]+0.7954951288348656*fC[13]; 
  df_rec_lo[10] = -(0.7654655446197428*(fL[25]+fC[25]))-0.7954951288348656*fL[15]+0.7954951288348656*fC[15]; 
  df_rec_lo[11] = -(0.7654655446197428*(fL[26]+fC[26]))-0.7954951288348656*fL[17]+0.7954951288348656*fC[17]; 
  df_rec_lo[12] = -(0.7654655446197428*(fL[27]+fC[27]))-0.7954951288348656*fL[20]+0.7954951288348656*fC[20]; 
  df_rec_lo[13] = -(0.7654655446197428*(fL[29]+fC[29]))-0.7954951288348656*fL[23]+0.7954951288348656*fC[23]; 
  df_rec_lo[14] = -(0.7654655446197428*(fL[30]+fC[30]))-0.7954951288348656*fL[24]+0.7954951288348656*fC[24]; 
  df_rec_lo[15] = -(0.7654655446197428*(fL[31]+fC[31]))-0.7954951288348656*fL[28]+0.7954951288348656*fC[28]; 
  df_rec_up[0] = -(0.7654655446197428*(fR[3]+fC[3]))+0.7954951288348656*fR[0]-0.7954951288348656*fC[0]; 
  df_rec_up[1] = -(0.7654655446197428*(fR[7]+fC[7]))+0.7954951288348656*fR[1]-0.7954951288348656*fC[1]; 
  df_rec_up[2] = -(0.7654655446197428*(fR[8]+fC[8]))+0.7954951288348656*fR[2]-0.7954951288348656*fC[2]; 
  df_rec_up[3] = -(0.7654655446197428*(fR[11]+fC[11]))+0.7954951288348656*fR[4]-0.7954951288348656*fC[4]; 
  df_rec_up[4] = -(0.7654655446197428*(fR[14]+fC[14]))+0.7954951288348656*fR[5]-0.7954951288348656*fC[5]; 
  df_rec_up[5] = -(0.7654655446197428*(fR[16]+fC[16]))+0.7954951288348656*fR[6]-0.7954951288348656*fC[6]; 
  df_rec_up[6] = -(0.7654655446197428*(fR[18]+fC[18]))+0.7954951288348656*fR[9]-0.7954951288348656*fC[9]; 
  df_rec_up[7] = -(0.7654655446197428*(fR[19]+fC[19]))+0.7954951288348656*fR[10]-0.7954951288348656*fC[10]; 
  df_rec_up[8] = -(0.7654655446197428*(fR[21]+fC[21]))+0.7954951288348656*fR[12]-0.7954951288348656*fC[12]; 
  df_rec_up[9] = -(0.7654655446197428*(fR[22]+fC[22]))+0.7954951288348656*fR[13]-0.7954951288348656*fC[13]; 
  df_rec_up[10] = -(0.7654655446197428*(fR[25]+fC[25]))+0.7954951288348656*fR[15]-0.7954951288348656*fC[15]; 
  df_rec_up[11] = -(0.7654655446197428*(fR[26]+fC[26]))+0.7954951288348656*fR[17]-0.7954951288348656*fC[17]; 
  df_rec_up[12] = -(0.7654655446197428*(fR[27]+fC[27]))+0.7954951288348656*fR[20]-0.7954951288348656*fC[20]; 
  df_rec_up[13] = -(0.7654655446197428*(fR[29]+fC[29]))+0.7954951288348656*fR[23]-0.7954951288348656*fC[23]; 
  df_rec_up[14] = -(0.7654655446197428*(fR[30]+fC[30]))+0.7954951288348656*fR[24]-0.7954951288348656*fC[24]; 
  df_rec_up[15] = -(0.7654655446197428*(fR[31]+fC[31]))+0.7954951288348656*fR[28]-0.7954951288348656*fC[28]; 
  ...
  vol[3] = 0.5303300858899105*(fC[28]*DC[31]+fC[24]*DC[30]+fC[23]*DC[29]+fC[20]*DC[27]+fC[17]*DC[26]+fC[15]*DC[25]+fC[13]*DC[22]+fC[12]*DC[21]+fC[10]*DC[19]+fC[9]*DC[18]+fC[6]*DC[16]+fC[5]*DC[14]+fC[4]*DC[11]+fC[2]*DC[8]+fC[1]*DC[7]+fC[0]*DC[3]); 
  vol[7] = 0.5303300858899105*(fC[24]*DC[31]+fC[28]*DC[30]+fC[15]*DC[29]+fC[13]*DC[27]+fC[10]*DC[26]+fC[23]*DC[25]+fC[20]*DC[22]+fC[5]*DC[21]+fC[17]*DC[19]+fC[4]*DC[18]+fC[2]*DC[16]+fC[12]*DC[14]+fC[9]*DC[11]+fC[6]*DC[8]+fC[0]*DC[7]+fC[1]*DC[3]); 
  vol[8] = 0.5303300858899105*(fC[23]*DC[31]+fC[15]*DC[30]+fC[28]*DC[29]+fC[12]*DC[27]+fC[9]*DC[26]+fC[24]*DC[25]+fC[5]*DC[22]+fC[20]*DC[21]+fC[4]*DC[19]+fC[17]*DC[18]+fC[1]*DC[16]+fC[13]*DC[14]+fC[10]*DC[11]+fC[0]*DC[8]+fC[6]*DC[7]+fC[2]*DC[3]); 
  vol[11] = 0.5303300858899105*(fC[20]*DC[31]+fC[13]*DC[30]+fC[12]*DC[29]+DC[27]*fC[28]+fC[6]*DC[26]+fC[5]*DC[25]+DC[22]*fC[24]+DC[21]*fC[23]+fC[2]*DC[19]+fC[1]*DC[18]+DC[16]*fC[17]+DC[14]*fC[15]+fC[0]*DC[11]+DC[8]*fC[10]+DC[7]*fC[9]+DC[3]*fC[4]); 
  vol[14] = 0.5303300858899105*(fC[17]*DC[31]+fC[10]*DC[30]+fC[9]*DC[29]+DC[26]*fC[28]+fC[6]*DC[27]+fC[4]*DC[25]+DC[19]*fC[24]+DC[18]*fC[23]+fC[2]*DC[22]+fC[1]*DC[21]+DC[16]*fC[20]+DC[11]*fC[15]+fC[0]*DC[14]+DC[8]*fC[13]+DC[7]*fC[12]+DC[3]*fC[5]); 
  vol[16] = 0.5303300858899105*(fC[15]*DC[31]+fC[23]*DC[30]+fC[24]*DC[29]+DC[25]*fC[28]+fC[5]*DC[27]+fC[4]*DC[26]+fC[12]*DC[22]+fC[13]*DC[21]+DC[14]*fC[20]+fC[9]*DC[19]+fC[10]*DC[18]+DC[11]*fC[17]+fC[0]*DC[16]+fC[1]*DC[8]+fC[2]*DC[7]+DC[3]*fC[6]); 
  vol[18] = 0.5303300858899105*(fC[13]*DC[31]+fC[20]*DC[30]+fC[5]*DC[29]+DC[22]*fC[28]+fC[24]*DC[27]+fC[2]*DC[26]+fC[12]*DC[25]+DC[14]*fC[23]+fC[15]*DC[21]+fC[6]*DC[19]+fC[0]*DC[18]+DC[8]*fC[17]+fC[10]*DC[16]+fC[1]*DC[11]+DC[3]*fC[9]+fC[4]*DC[7]); 
  vol[19] = 0.5303300858899105*(fC[12]*DC[31]+fC[5]*DC[30]+fC[20]*DC[29]+DC[21]*fC[28]+fC[23]*DC[27]+fC[1]*DC[26]+fC[13]*DC[25]+DC[14]*fC[24]+fC[15]*DC[22]+fC[0]*DC[19]+fC[6]*DC[18]+DC[7]*fC[17]+fC[9]*DC[16]+fC[2]*DC[11]+DC[3]*fC[10]+fC[4]*DC[8]); 
  vol[21] = 0.5303300858899105*(fC[10]*DC[31]+fC[17]*DC[30]+fC[4]*DC[29]+DC[19]*fC[28]+fC[2]*DC[27]+fC[24]*DC[26]+fC[9]*DC[25]+DC[11]*fC[23]+fC[6]*DC[22]+fC[0]*DC[21]+DC[8]*fC[20]+fC[15]*DC[18]+fC[13]*DC[16]+fC[1]*DC[14]+DC[3]*fC[12]+fC[5]*DC[7]); 
  vol[22] = 0.5303300858899105*(fC[9]*DC[31]+fC[4]*DC[30]+fC[17]*DC[29]+DC[18]*fC[28]+fC[1]*DC[27]+fC[23]*DC[26]+fC[10]*DC[25]+DC[11]*fC[24]+fC[0]*DC[22]+fC[6]*DC[21]+DC[7]*fC[20]+fC[15]*DC[19]+fC[12]*DC[16]+fC[2]*DC[14]+DC[3]*fC[13]+fC[5]*DC[8]); 
  vol[25] = 0.5303300858899105*(fC[6]*DC[31]+fC[2]*DC[30]+fC[1]*DC[29]+DC[16]*fC[28]+fC[17]*DC[27]+fC[20]*DC[26]+fC[0]*DC[25]+DC[8]*fC[24]+DC[7]*fC[23]+fC[10]*DC[22]+fC[9]*DC[21]+fC[13]*DC[19]+fC[12]*DC[18]+DC[3]*fC[15]+fC[4]*DC[14]+fC[5]*DC[11]); 
  vol[26] = 0.5303300858899105*(fC[5]*DC[31]+fC[12]*DC[30]+fC[13]*DC[29]+DC[14]*fC[28]+fC[15]*DC[27]+fC[0]*DC[26]+fC[20]*DC[25]+DC[21]*fC[24]+DC[22]*fC[23]+fC[1]*DC[19]+fC[2]*DC[18]+DC[3]*fC[17]+fC[4]*DC[16]+fC[6]*DC[11]+DC[7]*fC[10]+DC[8]*fC[9]); 
  vol[27] = 0.5303300858899105*(fC[4]*DC[31]+fC[9]*DC[30]+fC[10]*DC[29]+DC[11]*fC[28]+fC[0]*DC[27]+fC[15]*DC[26]+fC[17]*DC[25]+DC[18]*fC[24]+DC[19]*fC[23]+fC[1]*DC[22]+fC[2]*DC[21]+DC[3]*fC[20]+fC[5]*DC[16]+fC[6]*DC[14]+DC[7]*fC[13]+DC[8]*fC[12]); 
  vol[29] = 0.5303300858899105*(fC[2]*DC[31]+fC[6]*DC[30]+fC[0]*DC[29]+DC[8]*fC[28]+fC[10]*DC[27]+fC[13]*DC[26]+fC[1]*DC[25]+DC[16]*fC[24]+DC[3]*fC[23]+fC[17]*DC[22]+fC[4]*DC[21]+DC[19]*fC[20]+fC[5]*DC[18]+DC[7]*fC[15]+fC[9]*DC[14]+DC[11]*fC[12]); 
  vol[30] = 0.5303300858899105*(fC[1]*DC[31]+fC[0]*DC[30]+fC[6]*DC[29]+DC[7]*fC[28]+fC[9]*DC[27]+fC[12]*DC[26]+fC[2]*DC[25]+DC[3]*fC[24]+DC[16]*fC[23]+fC[4]*DC[22]+fC[17]*DC[21]+DC[18]*fC[20]+fC[5]*DC[19]+DC[8]*fC[15]+fC[10]*DC[14]+DC[11]*fC[13]); 
  vol[31] = 0.5303300858899105*(fC[0]*DC[31]+fC[1]*DC[30]+fC[2]*DC[29]+DC[3]*fC[28]+fC[4]*DC[27]+fC[5]*DC[26]+fC[6]*DC[25]+DC[7]*fC[24]+DC[8]*fC[23]+fC[9]*DC[22]+fC[10]*DC[21]+DC[11]*fC[20]+fC[12]*DC[19]+fC[13]*DC[18]+DC[14]*fC[17]+fC[15]*DC[16]); 
  ...
  out[7] += (0.5*vol[7]-0.6123724356957945*surft2_up[1]+0.6123724356957945*(surft2_lo[1]+surft1_up[1]+surft1_lo[1]))*dv_inv_sq; 
  out[8] += (0.5*vol[8]-0.6123724356957945*surft2_up[2]+0.6123724356957945*(surft2_lo[2]+surft1_up[2]+surft1_lo[2]))*dv_inv_sq; 
  out[9] += (0.5*vol[9]+0.35355339059327373*surft1_up[6]-0.35355339059327373*surft1_lo[6])*dv_inv_sq; 
  out[10] += (0.5*vol[10]+0.35355339059327373*surft1_up[7]-0.35355339059327373*surft1_lo[7])*dv_inv_sq; 
  ...
  out[14] += (0.5*vol[14]-0.6123724356957945*surft2_up[4]+0.6123724356957945*(surft2_lo[4]+surft1_up[4]+surft1_lo[4]))*dv_inv_sq; 
  out[15] += (0.5*vol[15]+0.35355339059327373*surft1_up[10]-0.35355339059327373*surft1_lo[10])*dv_inv_sq; 
  out[16] += (0.5*vol[16]-0.6123724356957945*surft2_up[5]+0.6123724356957945*(surft2_lo[5]+surft1_up[5]+surft1_lo[5]))*dv_inv_sq; 
  out[17] += (0.5*vol[17]+0.35355339059327373*surft1_up[11]-0.35355339059327373*surft1_lo[11])*dv_inv_sq; 
  ...
  out[21] += (0.5*vol[21]-0.6123724356957945*surft2_up[8]+0.6123724356957945*(surft2_lo[8]+surft1_up[8]+surft1_lo[8]))*dv_inv_sq; 
  out[22] += (0.5*vol[22]-0.6123724356957945*surft2_up[9]+0.6123724356957945*(surft2_lo[9]+surft1_up[9]+surft1_lo[9]))*dv_inv_sq; 
  out[23] += (0.5*vol[23]+0.35355339059327373*surft1_up[13]-0.35355339059327373*surft1_lo[13])*dv_inv_sq; 
  out[24] += (0.5*vol[24]+0.35355339059327373*surft1_up[14]-0.35355339059327373*surft1_lo[14])*dv_inv_sq; 
  ...
  out[27] += (0.5*vol[27]-0.6123724356957945*surft2_up[12]+0.6123724356957945*(surft2_lo[12]+surft1_up[12]+surft1_lo[12]))*dv_inv_sq; 
  out[28] += (0.5*vol[28]+0.35355339059327373*surft1_up[15]-0.35355339059327373*surft1_lo[15])*dv_inv_sq; 
