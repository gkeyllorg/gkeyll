...
GKYL_CU_DH double fpo_vlasov_diff_surfvxvz_1x3v_ser_p1(const double* dxv, const double* diff_coeff_C, 
  ...
  df_rec_lo[2] = -(0.11785113019775789*(fTL[14]+fBL[14]))+0.11785113019775789*(fTC[14]+fBC[14])+0.2357022603955158*fCL[14]-0.2357022603955158*fCC[14]-0.10206207261596573*(fTL[10]+fTC[10]+fBL[10]+fBC[10]+fTC[7]+fBL[7])+0.20412414523193148*(fCL[10]+fCC[10])+0.10206207261596573*(fTL[7]+fBC[7])+0.0883883476483184*(fTL[3]+fTC[3])-0.0883883476483184*(fBL[3]+fBC[3]); 
  df_rec_lo[3] = -(0.20412414523193148*(fTL[9]+fBC[9]))+0.20412414523193148*(fTC[9]+fBL[9])-0.1767766952966368*(fTL[4]+fTC[4]+fTC[2]+fBC[2])+0.1767766952966368*(fBL[4]+fBC[4]+fTL[2]+fBL[2])-0.3535533905932737*fCL[2]+0.3535533905932737*fCC[2]+0.15309310892394856*(fTL[0]+fTC[0]+fBL[0]+fBC[0])-0.3061862178478971*(fCL[0]+fCC[0]); 
  df_rec_lo[4] = -(0.11785113019775789*(fTL[15]+fBL[15]))+0.11785113019775789*(fTC[15]+fBC[15])+0.2357022603955158*fCL[15]-0.2357022603955158*fCC[15]-0.10206207261596573*(fTL[13]+fTC[13]+fBL[13]+fBC[13]+fTC[11]+fBL[11])+0.20412414523193148*(fCL[13]+fCC[13])+0.10206207261596573*(fTL[11]+fBC[11])+0.0883883476483184*(fTL[6]+fTC[6])-0.0883883476483184*(fBL[6]+fBC[6]); 
  df_rec_lo[5] = -(0.20412414523193148*(fTL[12]+fBC[12]))+0.20412414523193148*(fTC[12]+fBL[12])-0.1767766952966368*(fTL[8]+fTC[8]+fTC[5]+fBC[5])+0.1767766952966368*(fBL[8]+fBC[8]+fTL[5]+fBL[5])-0.3535533905932737*fCL[5]+0.3535533905932737*fCC[5]+0.15309310892394856*(fTL[1]+fTC[1]+fBL[1]+fBC[1])-0.3061862178478971*(fCL[1]+fCC[1]); 
  df_rec_lo[6] = -(0.20412414523193148*(fTL[14]+fBC[14]))+0.20412414523193148*(fTC[14]+fBL[14])-0.1767766952966368*(fTL[10]+fTC[10]+fTC[7]+fBC[7])+0.1767766952966368*(fBL[10]+fBC[10]+fTL[7]+fBL[7])-0.3535533905932737*fCL[7]+0.3535533905932737*fCC[7]+0.15309310892394856*(fTL[3]+fTC[3]+fBL[3]+fBC[3])-0.3061862178478971*(fCL[3]+fCC[3]); 
  df_rec_lo[7] = -(0.20412414523193148*(fTL[15]+fBC[15]))+0.20412414523193148*(fTC[15]+fBL[15])-0.1767766952966368*(fTL[13]+fTC[13]+fTC[11]+fBC[11])+0.1767766952966368*(fBL[13]+fBC[13]+fTL[11]+fBL[11])-0.3535533905932737*fCL[11]+0.3535533905932737*fCC[11]+0.15309310892394856*(fTL[6]+fTC[6]+fBL[6]+fBC[6])-0.3061862178478971*(fCL[6]+fCC[6]); 
