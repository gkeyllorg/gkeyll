...
{ 
  ...
  fUp_L[0] = 1.224744871391589*fL[3]+0.7071067811865475*fL[0]; 
  fUp_L[1] = 1.224744871391589*fL[6]+0.7071067811865475*fL[1]; 
  fUp_L[2] = 1.224744871391589*fL[7]+0.7071067811865475*fL[2]; 
  fUp_L[3] = 1.224744871391589*fL[10]+0.7071067811865475*fL[4]; 
  fUp_L[4] = 1.224744871391589*fL[11]+0.7071067811865475*fL[5]; 
  fUp_L[5] = 1.224744871391589*fL[13]+0.7071067811865475*fL[8]; 
  fUp_L[6] = 1.224744871391589*fL[14]+0.7071067811865475*fL[9]; 
  fUp_L[7] = 1.224744871391589*fL[15]+0.7071067811865475*fL[12]; 
    } else { 
  fUp_L[0] = 0.7071067811865475*fC[0]-1.224744871391589*fC[3]; 
  fUp_L[1] = 0.7071067811865475*fC[1]-1.224744871391589*fC[6]; 
  fUp_L[2] = 0.7071067811865475*fC[2]-1.224744871391589*fC[7]; 
  fUp_L[3] = 0.7071067811865475*fC[4]-1.224744871391589*fC[10]; 
  fUp_L[4] = 0.7071067811865475*fC[5]-1.224744871391589*fC[11]; 
  fUp_L[5] = 0.7071067811865475*fC[8]-1.224744871391589*fC[13]; 
  fUp_L[6] = 0.7071067811865475*fC[9]-1.224744871391589*fC[14]; 
  fUp_L[7] = 0.7071067811865475*fC[12]-1.224744871391589*fC[15]; 
   } 
  } else { 
  double fL_r[8] = {0.0}; 
  double fC_l[8] = {0.0}; 
  ...
  fL_r[0] = 1.224744871391589*fL[3]+0.7071067811865475*fL[0]; 
  fL_r[1] = 1.224744871391589*fL[6]+0.7071067811865475*fL[1]; 
  fL_r[2] = 1.224744871391589*fL[7]+0.7071067811865475*fL[2]; 
  fL_r[3] = 1.224744871391589*fL[10]+0.7071067811865475*fL[4]; 
  fL_r[4] = 1.224744871391589*fL[11]+0.7071067811865475*fL[5]; 
  fL_r[5] = 1.224744871391589*fL[13]+0.7071067811865475*fL[8]; 
  fL_r[6] = 1.224744871391589*fL[14]+0.7071067811865475*fL[9]; 
  fL_r[7] = 1.224744871391589*fL[15]+0.7071067811865475*fL[12]; 

  fC_l[0] = 0.7071067811865475*fC[0]-1.224744871391589*fC[3]; 
  fC_l[1] = 0.7071067811865475*fC[1]-1.224744871391589*fC[6]; 
  fC_l[2] = 0.7071067811865475*fC[2]-1.224744871391589*fC[7]; 
  fC_l[3] = 0.7071067811865475*fC[4]-1.224744871391589*fC[10]; 
  fC_l[4] = 0.7071067811865475*fC[5]-1.224744871391589*fC[11]; 
  fC_l[5] = 0.7071067811865475*fC[8]-1.224744871391589*fC[13]; 
  fC_l[6] = 0.7071067811865475*fC[9]-1.224744871391589*fC[14]; 
  fC_l[7] = 0.7071067811865475*fC[12]-1.224744871391589*fC[15]; 
  ...
  fUp_R[0] = 1.224744871391589*fC[3]+0.7071067811865475*fC[0]; 
  fUp_R[1] = 1.224744871391589*fC[6]+0.7071067811865475*fC[1]; 
  fUp_R[2] = 1.224744871391589*fC[7]+0.7071067811865475*fC[2]; 
  fUp_R[3] = 1.224744871391589*fC[10]+0.7071067811865475*fC[4]; 
  fUp_R[4] = 1.224744871391589*fC[11]+0.7071067811865475*fC[5]; 
  fUp_R[5] = 1.224744871391589*fC[13]+0.7071067811865475*fC[8]; 
  fUp_R[6] = 1.224744871391589*fC[14]+0.7071067811865475*fC[9]; 
  fUp_R[7] = 1.224744871391589*fC[15]+0.7071067811865475*fC[12]; 
    } else { 
  fUp_R[0] = 0.7071067811865475*fR[0]-1.224744871391589*fR[3]; 
  fUp_R[1] = 0.7071067811865475*fR[1]-1.224744871391589*fR[6]; 
  fUp_R[2] = 0.7071067811865475*fR[2]-1.224744871391589*fR[7]; 
  fUp_R[3] = 0.7071067811865475*fR[4]-1.224744871391589*fR[10]; 
  fUp_R[4] = 0.7071067811865475*fR[5]-1.224744871391589*fR[11]; 
  fUp_R[5] = 0.7071067811865475*fR[8]-1.224744871391589*fR[13]; 
  fUp_R[6] = 0.7071067811865475*fR[9]-1.224744871391589*fR[14]; 
  fUp_R[7] = 0.7071067811865475*fR[12]-1.224744871391589*fR[15]; 
   } 
  } else { 
  double fC_r[8] = {0.0}; 
  double fR_l[8] = {0.0}; 
  ...
  fC_r[0] = 1.224744871391589*fC[3]+0.7071067811865475*fC[0]; 
  fC_r[1] = 1.224744871391589*fC[6]+0.7071067811865475*fC[1]; 
  fC_r[2] = 1.224744871391589*fC[7]+0.7071067811865475*fC[2]; 
  fC_r[3] = 1.224744871391589*fC[10]+0.7071067811865475*fC[4]; 
  fC_r[4] = 1.224744871391589*fC[11]+0.7071067811865475*fC[5]; 
  fC_r[5] = 1.224744871391589*fC[13]+0.7071067811865475*fC[8]; 
  fC_r[6] = 1.224744871391589*fC[14]+0.7071067811865475*fC[9]; 
  fC_r[7] = 1.224744871391589*fC[15]+0.7071067811865475*fC[12]; 

  fR_l[0] = 0.7071067811865475*fR[0]-1.224744871391589*fR[3]; 
  fR_l[1] = 0.7071067811865475*fR[1]-1.224744871391589*fR[6]; 
  fR_l[2] = 0.7071067811865475*fR[2]-1.224744871391589*fR[7]; 
  fR_l[3] = 0.7071067811865475*fR[4]-1.224744871391589*fR[10]; 
  fR_l[4] = 0.7071067811865475*fR[5]-1.224744871391589*fR[11]; 
  fR_l[5] = 0.7071067811865475*fR[8]-1.224744871391589*fR[13]; 
  fR_l[6] = 0.7071067811865475*fR[9]-1.224744871391589*fR[14]; 
  fR_l[7] = 0.7071067811865475*fR[12]-1.224744871391589*fR[15]; 
