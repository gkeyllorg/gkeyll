...
#include <gkyl_basis_tensor_2x_p3_exp_sq.h> 
#include <gkyl_basis_tensor_2x_p3_sqrt.h> 
...
{ 
  ...
  tensor_2x_p3_exp_sq(V_0, V_0_sq); 
  ...
  GammaV_sq[12] = V_0_sq[12]; 
  GammaV_sq[13] = V_0_sq[13]; 
  GammaV_sq[14] = V_0_sq[14]; 
  GammaV_sq[15] = V_0_sq[15]; 

  tensor_2x_p3_sqrt(GammaV_sq, GammaV); 
} 
