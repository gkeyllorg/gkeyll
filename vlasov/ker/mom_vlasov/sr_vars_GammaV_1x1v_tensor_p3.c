...
#include <gkyl_basis_tensor_1x_p3_exp_sq.h> 
#include <gkyl_basis_tensor_1x_p3_sqrt.h> 
...
{ 
  ...
  tensor_1x_p3_exp_sq(V_0, V_0_sq); 
 
  GammaV_sq[0] = V_0_sq[0]+1.4142135623730951; 
  GammaV_sq[1] = V_0_sq[1]; 
  GammaV_sq[2] = V_0_sq[2]; 
  GammaV_sq[3] = V_0_sq[3]; 

  tensor_1x_p3_sqrt(GammaV_sq, GammaV); 
} 
