...
{ 
  ...
  Gamma2_inv[0] = -(1.0*V_2_sq[0])-1.0*V_1_sq[0]-1.0*V_0_sq[0]+1.4142135623730951; 
  ...
  if (cell_avg) { 
    ...
    V0_quad = 1.5811388300841895*V_0[2]-1.224744871391589*V_0[1]+0.7071067811865475*V_0[0]; 
    V1_quad = 1.5811388300841895*V_1[2]-1.224744871391589*V_1[1]+0.7071067811865475*V_1[0]; 
    V2_quad = 1.5811388300841895*V_2[2]-1.224744871391589*V_2[1]+0.7071067811865475*V_2[0]; 
    ...
    n[2] = 0.45175395145262565*Gamma_inv[2]*M0[2]+0.7071067811865475*Gamma_inv[0]*M0[2]+0.7071067811865475*M0[0]*Gamma_inv[2]+0.6324555320336759*Gamma_inv[1]*M0[1]; 
  } 
