...
{ 
  ...
  for (int i=0; i<8; ++i) {
    ...
    Q_l_quad = jacob_pos_l_inv*(1.5811388300841895*em_l[2]+1.224744871391589*em_l[1]+0.7071067811865475*em_l[0]); 
    Q_r_quad = jacob_pos_r_inv*(1.5811388300841895*em_r[2]-1.224744871391589*em_r[1]+0.7071067811865475*em_r[0]); 
    U_l_quad = jacob_pos_l_inv*(1.5811388300841895*em_no_J_l[2]+1.224744871391589*em_no_J_l[1]+0.7071067811865475*em_no_J_l[0]); 
    U_r_quad = jacob_pos_r_inv*(1.5811388300841895*em_no_J_r[2]-1.224744871391589*em_no_J_r[1]+0.7071067811865475*em_no_J_r[0]); 
    if (theta_pole) { 
