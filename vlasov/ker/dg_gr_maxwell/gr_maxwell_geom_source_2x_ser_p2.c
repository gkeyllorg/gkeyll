...
{ 
  ...
  const double *Jphi = &fields[48]; 
  const double *Jpsi = &fields[56]; 
  
  double *outJDx = &out[0]; 
  double *outJDy = &out[8]; 
  double *outJDz = &out[16]; 
  double *outJBx = &out[24]; 
  double *outJBy = &out[32]; 
  double *outJBz = &out[40]; 
  double *outJphi = &out[48]; 
  double *outJpsi = &out[56]; 
  
  Jphi_n[0] = -(0.5999999999999995*Jphi[7])-0.5999999999999999*Jphi[6]+0.4472135954999579*Jphi[5]+0.4472135954999579*Jphi[4]+0.9*Jphi[3]-0.6708203932499369*Jphi[2]-0.6708203932499369*Jphi[1]+0.5*Jphi[0];
  Jpsi_n[0] = -(0.5999999999999995*Jpsi[7])-0.5999999999999999*Jpsi[6]+0.4472135954999579*Jpsi[5]+0.4472135954999579*Jpsi[4]+0.9*Jpsi[3]-0.6708203932499369*Jpsi[2]-0.6708203932499369*Jpsi[1]+0.5*Jpsi[0];
  
  Jphi_n[1] = 0.75*Jphi[7]-0.5590169943749475*Jphi[5]+0.4472135954999579*Jphi[4]-0.6708203932499369*Jphi[1]+0.5*Jphi[0];
  Jpsi_n[1] = 0.75*Jpsi[7]-0.5590169943749475*Jpsi[5]+0.4472135954999579*Jpsi[4]-0.6708203932499369*Jpsi[1]+0.5*Jpsi[0];
  
  Jphi_n[2] = -(0.5999999999999995*Jphi[7])+0.5999999999999999*Jphi[6]+0.4472135954999579*Jphi[5]+0.4472135954999579*Jphi[4]-0.9*Jphi[3]+0.6708203932499369*Jphi[2]-0.6708203932499369*Jphi[1]+0.5*Jphi[0];
  Jpsi_n[2] = -(0.5999999999999995*Jpsi[7])+0.5999999999999999*Jpsi[6]+0.4472135954999579*Jpsi[5]+0.4472135954999579*Jpsi[4]-0.9*Jpsi[3]+0.6708203932499369*Jpsi[2]-0.6708203932499369*Jpsi[1]+0.5*Jpsi[0];
  
  Jphi_n[3] = 0.75*Jphi[6]+0.4472135954999579*Jphi[5]-0.5590169943749475*Jphi[4]-0.6708203932499369*Jphi[2]+0.5*Jphi[0];
  Jpsi_n[3] = 0.75*Jpsi[6]+0.4472135954999579*Jpsi[5]-0.5590169943749475*Jpsi[4]-0.6708203932499369*Jpsi[2]+0.5*Jpsi[0];
  
  Jphi_n[4] = -(0.5590169943749475*Jphi[5])-0.5590169943749475*Jphi[4]+0.5*Jphi[0];
  Jpsi_n[4] = -(0.5590169943749475*Jpsi[5])-0.5590169943749475*Jpsi[4]+0.5*Jpsi[0];
  
  Jphi_n[5] = -(0.75*Jphi[6])+0.4472135954999579*Jphi[5]-0.5590169943749475*Jphi[4]+0.6708203932499369*Jphi[2]+0.5*Jphi[0];
  Jpsi_n[5] = -(0.75*Jpsi[6])+0.4472135954999579*Jpsi[5]-0.5590169943749475*Jpsi[4]+0.6708203932499369*Jpsi[2]+0.5*Jpsi[0];
  
  Jphi_n[6] = 0.5999999999999995*Jphi[7]-0.5999999999999999*Jphi[6]+0.4472135954999579*Jphi[5]+0.4472135954999579*Jphi[4]-0.9*Jphi[3]-0.6708203932499369*Jphi[2]+0.6708203932499369*Jphi[1]+0.5*Jphi[0];
  Jpsi_n[6] = 0.5999999999999995*Jpsi[7]-0.5999999999999999*Jpsi[6]+0.4472135954999579*Jpsi[5]+0.4472135954999579*Jpsi[4]-0.9*Jpsi[3]-0.6708203932499369*Jpsi[2]+0.6708203932499369*Jpsi[1]+0.5*Jpsi[0];
  
  Jphi_n[7] = -(0.75*Jphi[7])-0.5590169943749475*Jphi[5]+0.4472135954999579*Jphi[4]+0.6708203932499369*Jphi[1]+0.5*Jphi[0];
  Jpsi_n[7] = -(0.75*Jpsi[7])-0.5590169943749475*Jpsi[5]+0.4472135954999579*Jpsi[4]+0.6708203932499369*Jpsi[1]+0.5*Jpsi[0];
  
  Jphi_n[8] = 0.5999999999999995*Jphi[7]+0.5999999999999999*Jphi[6]+0.4472135954999579*Jphi[5]+0.4472135954999579*Jphi[4]+0.9*Jphi[3]+0.6708203932499369*Jphi[2]+0.6708203932499369*Jphi[1]+0.5*Jphi[0];
  Jpsi_n[8] = 0.5999999999999995*Jpsi[7]+0.5999999999999999*Jpsi[6]+0.4472135954999579*Jpsi[5]+0.4472135954999579*Jpsi[4]+0.9*Jpsi[3]+0.6708203932499369*Jpsi[2]+0.6708203932499369*Jpsi[1]+0.5*Jpsi[0];
