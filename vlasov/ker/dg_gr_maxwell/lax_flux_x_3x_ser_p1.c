...
{ 
  ...
  for (int i=0; i<8; ++i) {
    ...
    Q_l_quad = jacob_pos_l_inv*(0.6123724356957944*em_l[7]+0.3535533905932737*em_l[6]-0.6123724356957944*em_l[5]-0.6123724356957944*em_l[4]-0.3535533905932737*em_l[3]-0.3535533905932737*em_l[2]+0.6123724356957944*em_l[1]+0.3535533905932737*em_l[0]); 
    Q_r_quad = jacob_pos_r_inv*(-(0.6123724356957944*em_r[7])+0.3535533905932737*em_r[6]+0.6123724356957944*em_r[5]+0.6123724356957944*em_r[4]-0.3535533905932737*em_r[3]-0.3535533905932737*em_r[2]-0.6123724356957944*em_r[1]+0.3535533905932737*em_r[0]); 
    U_l_quad = jacob_pos_l_inv*(0.6123724356957944*em_no_J_l[7]+0.3535533905932737*em_no_J_l[6]-0.6123724356957944*em_no_J_l[5]-0.6123724356957944*em_no_J_l[4]-0.3535533905932737*em_no_J_l[3]-0.3535533905932737*em_no_J_l[2]+0.6123724356957944*em_no_J_l[1]+0.3535533905932737*em_no_J_l[0]); 
    U_r_quad = jacob_pos_r_inv*(-(0.6123724356957944*em_no_J_r[7])+0.3535533905932737*em_no_J_r[6]+0.6123724356957944*em_no_J_r[5]+0.6123724356957944*em_no_J_r[4]-0.3535533905932737*em_no_J_r[3]-0.3535533905932737*em_no_J_r[2]-0.6123724356957944*em_no_J_r[1]+0.3535533905932737*em_no_J_r[0]); 
    if (theta_pole) { 
