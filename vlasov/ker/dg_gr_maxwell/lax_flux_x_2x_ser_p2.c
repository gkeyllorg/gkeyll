...
{ 
  ...
  for (int i=0; i<8; ++i) {
    ...
    Q_l_quad = jacob_pos_l_inv*(0.7745966692414833*em_l[7]-1.5*em_l[6]+0.4472135954999579*em_l[5]+1.118033988749895*em_l[4]-1.1618950038622249*em_l[3]-0.6708203932499369*em_l[2]+0.8660254037844386*em_l[1]+0.5*em_l[0]); 
    Q_r_quad = jacob_pos_r_inv*(-(0.7745966692414833*em_r[7])-1.5*em_r[6]+0.4472135954999579*em_r[5]+1.118033988749895*em_r[4]+1.1618950038622249*em_r[3]-0.6708203932499369*em_r[2]-0.8660254037844386*em_r[1]+0.5*em_r[0]); 
    U_l_quad = jacob_pos_l_inv*(0.7745966692414833*em_no_J_l[7]-1.5*em_no_J_l[6]+0.4472135954999579*em_no_J_l[5]+1.118033988749895*em_no_J_l[4]-1.1618950038622249*em_no_J_l[3]-0.6708203932499369*em_no_J_l[2]+0.8660254037844386*em_no_J_l[1]+0.5*em_no_J_l[0]); 
    U_r_quad = jacob_pos_r_inv*(-(0.7745966692414833*em_no_J_r[7])-1.5*em_no_J_r[6]+0.4472135954999579*em_no_J_r[5]+1.118033988749895*em_no_J_r[4]+1.1618950038622249*em_no_J_r[3]-0.6708203932499369*em_no_J_r[2]-0.8660254037844386*em_no_J_r[1]+0.5*em_no_J_r[0]); 
    if (theta_pole) { 
    ...
    Q_l_quad = jacob_pos_l_inv*(-(0.9682458365518543*em_l[7])-0.5590169943749475*em_l[5]+1.118033988749895*em_l[4]+0.8660254037844386*em_l[1]+0.5*em_l[0]); 
    Q_r_quad = jacob_pos_r_inv*(0.9682458365518543*em_r[7]-0.5590169943749475*em_r[5]+1.118033988749895*em_r[4]-0.8660254037844386*em_r[1]+0.5*em_r[0]); 
    U_l_quad = jacob_pos_l_inv*(-(0.9682458365518543*em_no_J_l[7])-0.5590169943749475*em_no_J_l[5]+1.118033988749895*em_no_J_l[4]+0.8660254037844386*em_no_J_l[1]+0.5*em_no_J_l[0]); 
    U_r_quad = jacob_pos_r_inv*(0.9682458365518543*em_no_J_r[7]-0.5590169943749475*em_no_J_r[5]+1.118033988749895*em_no_J_r[4]-0.8660254037844386*em_no_J_r[1]+0.5*em_no_J_r[0]); 
    if (theta_pole) { 
