...
{ 
  ...
  for (int i=0; i<8; ++i) {
    ...
    Q_l_quad = jacob_pos_l_inv*(-(0.8660254037844386*em_l[3])-0.5*em_l[2]+0.8660254037844386*em_l[1]+0.5*em_l[0]); 
    Q_r_quad = jacob_pos_r_inv*(0.8660254037844386*em_r[3]-0.5*em_r[2]-0.8660254037844386*em_r[1]+0.5*em_r[0]); 
    U_l_quad = jacob_pos_l_inv*(-(0.8660254037844386*em_no_J_l[3])-0.5*em_no_J_l[2]+0.8660254037844386*em_no_J_l[1]+0.5*em_no_J_l[0]); 
    U_r_quad = jacob_pos_r_inv*(0.8660254037844386*em_no_J_r[3]-0.5*em_no_J_r[2]-0.8660254037844386*em_no_J_r[1]+0.5*em_no_J_r[0]); 
    if (theta_pole) { 
