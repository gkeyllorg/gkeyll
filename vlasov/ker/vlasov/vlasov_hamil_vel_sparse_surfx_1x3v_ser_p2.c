...
{ 
  ...
  Ghat_l[0] = 1.369306393762915*fUpwind_l[1]*hamil[7]+0.6123724356957944*fUpwind_l[0]*hamil[1]; 
  Ghat_l[1] = (1.224744871391589*fUpwind_l[7]+1.369306393762915*fUpwind_l[0])*hamil[7]+0.6123724356957944*fUpwind_l[1]*hamil[1]; 
  Ghat_l[2] = 1.369306393762915*fUpwind_l[4]*hamil[7]+0.6123724356957944*hamil[1]*fUpwind_l[2]; 
  Ghat_l[3] = 1.369306393762915*fUpwind_l[5]*hamil[7]+0.6123724356957944*hamil[1]*fUpwind_l[3]; 
  Ghat_l[4] = hamil[7]*(1.224744871391589*fUpwind_l[11]+1.369306393762915*fUpwind_l[2])+0.6123724356957944*hamil[1]*fUpwind_l[4]; 
  Ghat_l[5] = hamil[7]*(1.224744871391589*fUpwind_l[13]+1.369306393762915*fUpwind_l[3])+0.6123724356957944*hamil[1]*fUpwind_l[5]; 
  Ghat_l[6] = 1.369306393762915*hamil[7]*fUpwind_l[10]+0.6123724356957944*hamil[1]*fUpwind_l[6]; 
  Ghat_l[7] = 1.224744871391589*fUpwind_l[1]*hamil[7]+0.6123724356957944*hamil[1]*fUpwind_l[7]; 
  Ghat_l[8] = 1.369306393762915*hamil[7]*fUpwind_l[12]+0.6123724356957944*hamil[1]*fUpwind_l[8]; 
  Ghat_l[9] = 1.369306393762915*hamil[7]*fUpwind_l[15]+0.6123724356957944*hamil[1]*fUpwind_l[9]; 
  Ghat_l[10] = 1.224744871391589*hamil[7]*fUpwind_l[17]+0.6123724356957944*hamil[1]*fUpwind_l[10]+1.369306393762915*fUpwind_l[6]*hamil[7]; 
  Ghat_l[11] = 0.6123724356957944*hamil[1]*fUpwind_l[11]+1.224744871391589*fUpwind_l[4]*hamil[7]; 
  Ghat_l[12] = 0.6123724356957944*hamil[1]*fUpwind_l[12]+1.369306393762915*hamil[7]*fUpwind_l[8]; 
  Ghat_l[13] = 0.6123724356957944*hamil[1]*fUpwind_l[13]+1.224744871391589*fUpwind_l[5]*hamil[7]; 
  Ghat_l[14] = 1.369306393762915*hamil[7]*fUpwind_l[18]+0.6123724356957944*hamil[1]*fUpwind_l[14]; 
  Ghat_l[15] = 0.6123724356957944*hamil[1]*fUpwind_l[15]+1.369306393762915*hamil[7]*fUpwind_l[9]; 
  Ghat_l[16] = 1.369306393762915*hamil[7]*fUpwind_l[19]+0.6123724356957944*hamil[1]*fUpwind_l[16]; 
  Ghat_l[17] = 0.6123724356957944*hamil[1]*fUpwind_l[17]+1.224744871391589*hamil[7]*fUpwind_l[10]; 
  Ghat_l[18] = 0.6123724356957944*hamil[1]*fUpwind_l[18]+1.369306393762915*hamil[7]*fUpwind_l[14]; 
  Ghat_l[19] = 0.6123724356957944*hamil[1]*fUpwind_l[19]+1.369306393762915*hamil[7]*fUpwind_l[16]; 

  Ghat_r[0] = 1.369306393762915*fUpwind_r[1]*hamil[7]+0.6123724356957944*fUpwind_r[0]*hamil[1]; 
  Ghat_r[1] = (1.224744871391589*fUpwind_r[7]+1.369306393762915*fUpwind_r[0])*hamil[7]+0.6123724356957944*fUpwind_r[1]*hamil[1]; 
  Ghat_r[2] = 1.369306393762915*fUpwind_r[4]*hamil[7]+0.6123724356957944*hamil[1]*fUpwind_r[2]; 
  Ghat_r[3] = 1.369306393762915*fUpwind_r[5]*hamil[7]+0.6123724356957944*hamil[1]*fUpwind_r[3]; 
  Ghat_r[4] = hamil[7]*(1.224744871391589*fUpwind_r[11]+1.369306393762915*fUpwind_r[2])+0.6123724356957944*hamil[1]*fUpwind_r[4]; 
  Ghat_r[5] = hamil[7]*(1.224744871391589*fUpwind_r[13]+1.369306393762915*fUpwind_r[3])+0.6123724356957944*hamil[1]*fUpwind_r[5]; 
  Ghat_r[6] = 1.369306393762915*hamil[7]*fUpwind_r[10]+0.6123724356957944*hamil[1]*fUpwind_r[6]; 
  Ghat_r[7] = 1.224744871391589*fUpwind_r[1]*hamil[7]+0.6123724356957944*hamil[1]*fUpwind_r[7]; 
  Ghat_r[8] = 1.369306393762915*hamil[7]*fUpwind_r[12]+0.6123724356957944*hamil[1]*fUpwind_r[8]; 
  Ghat_r[9] = 1.369306393762915*hamil[7]*fUpwind_r[15]+0.6123724356957944*hamil[1]*fUpwind_r[9]; 
  Ghat_r[10] = 1.224744871391589*hamil[7]*fUpwind_r[17]+0.6123724356957944*hamil[1]*fUpwind_r[10]+1.369306393762915*fUpwind_r[6]*hamil[7]; 
  Ghat_r[11] = 0.6123724356957944*hamil[1]*fUpwind_r[11]+1.224744871391589*fUpwind_r[4]*hamil[7]; 
  Ghat_r[12] = 0.6123724356957944*hamil[1]*fUpwind_r[12]+1.369306393762915*hamil[7]*fUpwind_r[8]; 
  Ghat_r[13] = 0.6123724356957944*hamil[1]*fUpwind_r[13]+1.224744871391589*fUpwind_r[5]*hamil[7]; 
  Ghat_r[14] = 1.369306393762915*hamil[7]*fUpwind_r[18]+0.6123724356957944*hamil[1]*fUpwind_r[14]; 
  Ghat_r[15] = 0.6123724356957944*hamil[1]*fUpwind_r[15]+1.369306393762915*hamil[7]*fUpwind_r[9]; 
  Ghat_r[16] = 1.369306393762915*hamil[7]*fUpwind_r[19]+0.6123724356957944*hamil[1]*fUpwind_r[16]; 
  Ghat_r[17] = 0.6123724356957944*hamil[1]*fUpwind_r[17]+1.224744871391589*hamil[7]*fUpwind_r[10]; 
  Ghat_r[18] = 0.6123724356957944*hamil[1]*fUpwind_r[18]+1.369306393762915*hamil[7]*fUpwind_r[14]; 
  Ghat_r[19] = 0.6123724356957944*hamil[1]*fUpwind_r[19]+1.369306393762915*hamil[7]*fUpwind_r[16]; 
