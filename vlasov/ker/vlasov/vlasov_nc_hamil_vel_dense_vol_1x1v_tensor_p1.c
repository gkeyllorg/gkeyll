...
{ 
  ...
  out[1] += (3.3541019662496847*poisson_tensor_conf_0[1]*hamil[2]*f_dJv0[3]+3.3541019662496847*poisson_tensor_conf_0[0]*f_dJv0[2]*hamil[2]+1.5*f_dJv0[1]*hamil[1]*poisson_tensor_conf_0[1]+1.5*f_dJv0[0]*poisson_tensor_conf_0[0]*hamil[1])*dv10*dx10*jacob_cx_inv; 
  out[3] += (3.0*poisson_tensor_conf_0[1]*hamil[2]*f_dJv0[5]+3.0*poisson_tensor_conf_0[0]*hamil[2]*f_dJv0[4]+1.5*hamil[1]*poisson_tensor_conf_0[1]*f_dJv0[3]+3.3541019662496847*f_dJv0[1]*poisson_tensor_conf_0[1]*hamil[2]+3.3541019662496847*f_dJv0[0]*poisson_tensor_conf_0[0]*hamil[2]+1.5*poisson_tensor_conf_0[0]*hamil[1]*f_dJv0[2])*dv10*dx10*jacob_cx_inv; 
  out[5] += (1.5*hamil[1]*poisson_tensor_conf_0[1]*f_dJv0[5]+1.5*poisson_tensor_conf_0[0]*hamil[1]*f_dJv0[4]+3.0*poisson_tensor_conf_0[1]*hamil[2]*f_dJv0[3]+3.0*poisson_tensor_conf_0[0]*f_dJv0[2]*hamil[2])*dv10*dx10*jacob_cx_inv; 
