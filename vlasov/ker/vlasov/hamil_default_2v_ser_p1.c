...
{ 
  ...
  hamil[0] = hamil_vy_nodal[1]+hamil_vx_nodal[1]+hamil_vy_nodal[0]+hamil_vx_nodal[0]; 
  hamil[1] = 0.5773502691896258*hamil_vx_nodal[1]-0.5773502691896258*hamil_vx_nodal[0]; 
  hamil[2] = 0.5773502691896258*hamil_vy_nodal[1]-0.5773502691896258*hamil_vy_nodal[0]; 
  hamil[3] = 0.0; 
