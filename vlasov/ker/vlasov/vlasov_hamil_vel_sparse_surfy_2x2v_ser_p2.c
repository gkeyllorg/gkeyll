...
{ 
  ...
  Ghat_l[0] = 1.9364916731037085*fUpwind_l[3]*hamil[5]+0.8660254037844386*fUpwind_l[0]*hamil[2]; 
  Ghat_l[1] = 1.9364916731037085*fUpwind_l[5]*hamil[5]+0.8660254037844386*fUpwind_l[1]*hamil[2]; 
  Ghat_l[2] = 1.9364916731037085*hamil[5]*fUpwind_l[6]+0.8660254037844386*fUpwind_l[2]*hamil[2]; 
  Ghat_l[3] = hamil[5]*(1.7320508075688772*fUpwind_l[9]+1.9364916731037085*fUpwind_l[0])+0.8660254037844386*hamil[2]*fUpwind_l[3]; 
  Ghat_l[4] = 1.9364916731037085*hamil[5]*fUpwind_l[10]+0.8660254037844386*hamil[2]*fUpwind_l[4]; 
  Ghat_l[5] = hamil[5]*(1.7320508075688774*fUpwind_l[15]+1.9364916731037085*fUpwind_l[1])+0.8660254037844386*hamil[2]*fUpwind_l[5]; 
  Ghat_l[6] = 1.7320508075688774*hamil[5]*fUpwind_l[16]+0.8660254037844386*hamil[2]*fUpwind_l[6]+1.9364916731037085*fUpwind_l[2]*hamil[5]; 
  Ghat_l[7] = 1.9364916731037085*hamil[5]*fUpwind_l[13]+0.8660254037844386*hamil[2]*fUpwind_l[7]; 
  Ghat_l[8] = 1.9364916731037085*hamil[5]*fUpwind_l[14]+0.8660254037844386*hamil[2]*fUpwind_l[8]; 
  Ghat_l[9] = 0.8660254037844386*hamil[2]*fUpwind_l[9]+1.7320508075688772*fUpwind_l[3]*hamil[5]; 
  Ghat_l[10] = 1.7320508075688772*hamil[5]*fUpwind_l[19]+0.8660254037844386*hamil[2]*fUpwind_l[10]+1.9364916731037085*fUpwind_l[4]*hamil[5]; 
  Ghat_l[11] = 1.9364916731037085*hamil[5]*fUpwind_l[17]+0.8660254037844386*hamil[2]*fUpwind_l[11]; 
  Ghat_l[12] = 1.9364916731037085*hamil[5]*fUpwind_l[18]+0.8660254037844386*hamil[2]*fUpwind_l[12]; 
  Ghat_l[13] = 0.8660254037844386*hamil[2]*fUpwind_l[13]+1.9364916731037085*hamil[5]*fUpwind_l[7]; 
  Ghat_l[14] = 0.8660254037844386*hamil[2]*fUpwind_l[14]+1.9364916731037085*hamil[5]*fUpwind_l[8]; 
  Ghat_l[15] = 0.8660254037844386*hamil[2]*fUpwind_l[15]+1.7320508075688774*fUpwind_l[5]*hamil[5]; 
  Ghat_l[16] = 0.8660254037844386*hamil[2]*fUpwind_l[16]+1.7320508075688774*hamil[5]*fUpwind_l[6]; 
  Ghat_l[17] = 0.8660254037844386*hamil[2]*fUpwind_l[17]+1.9364916731037085*hamil[5]*fUpwind_l[11]; 
  Ghat_l[18] = 0.8660254037844386*hamil[2]*fUpwind_l[18]+1.9364916731037085*hamil[5]*fUpwind_l[12]; 
  Ghat_l[19] = 0.8660254037844386*hamil[2]*fUpwind_l[19]+1.7320508075688772*hamil[5]*fUpwind_l[10]; 

  Ghat_r[0] = 1.9364916731037085*fUpwind_r[3]*hamil[5]+0.8660254037844386*fUpwind_r[0]*hamil[2]; 
  Ghat_r[1] = 1.9364916731037085*fUpwind_r[5]*hamil[5]+0.8660254037844386*fUpwind_r[1]*hamil[2]; 
  Ghat_r[2] = 1.9364916731037085*hamil[5]*fUpwind_r[6]+0.8660254037844386*fUpwind_r[2]*hamil[2]; 
  Ghat_r[3] = hamil[5]*(1.7320508075688772*fUpwind_r[9]+1.9364916731037085*fUpwind_r[0])+0.8660254037844386*hamil[2]*fUpwind_r[3]; 
  Ghat_r[4] = 1.9364916731037085*hamil[5]*fUpwind_r[10]+0.8660254037844386*hamil[2]*fUpwind_r[4]; 
  Ghat_r[5] = hamil[5]*(1.7320508075688774*fUpwind_r[15]+1.9364916731037085*fUpwind_r[1])+0.8660254037844386*hamil[2]*fUpwind_r[5]; 
  Ghat_r[6] = 1.7320508075688774*hamil[5]*fUpwind_r[16]+0.8660254037844386*hamil[2]*fUpwind_r[6]+1.9364916731037085*fUpwind_r[2]*hamil[5]; 
  Ghat_r[7] = 1.9364916731037085*hamil[5]*fUpwind_r[13]+0.8660254037844386*hamil[2]*fUpwind_r[7]; 
  Ghat_r[8] = 1.9364916731037085*hamil[5]*fUpwind_r[14]+0.8660254037844386*hamil[2]*fUpwind_r[8]; 
  Ghat_r[9] = 0.8660254037844386*hamil[2]*fUpwind_r[9]+1.7320508075688772*fUpwind_r[3]*hamil[5]; 
  Ghat_r[10] = 1.7320508075688772*hamil[5]*fUpwind_r[19]+0.8660254037844386*hamil[2]*fUpwind_r[10]+1.9364916731037085*fUpwind_r[4]*hamil[5]; 
  Ghat_r[11] = 1.9364916731037085*hamil[5]*fUpwind_r[17]+0.8660254037844386*hamil[2]*fUpwind_r[11]; 
  Ghat_r[12] = 1.9364916731037085*hamil[5]*fUpwind_r[18]+0.8660254037844386*hamil[2]*fUpwind_r[12]; 
  Ghat_r[13] = 0.8660254037844386*hamil[2]*fUpwind_r[13]+1.9364916731037085*hamil[5]*fUpwind_r[7]; 
  Ghat_r[14] = 0.8660254037844386*hamil[2]*fUpwind_r[14]+1.9364916731037085*hamil[5]*fUpwind_r[8]; 
  Ghat_r[15] = 0.8660254037844386*hamil[2]*fUpwind_r[15]+1.7320508075688774*fUpwind_r[5]*hamil[5]; 
  Ghat_r[16] = 0.8660254037844386*hamil[2]*fUpwind_r[16]+1.7320508075688774*hamil[5]*fUpwind_r[6]; 
  Ghat_r[17] = 0.8660254037844386*hamil[2]*fUpwind_r[17]+1.9364916731037085*hamil[5]*fUpwind_r[11]; 
  Ghat_r[18] = 0.8660254037844386*hamil[2]*fUpwind_r[18]+1.9364916731037085*hamil[5]*fUpwind_r[12]; 
  Ghat_r[19] = 0.8660254037844386*hamil[2]*fUpwind_r[19]+1.7320508075688772*hamil[5]*fUpwind_r[10]; 
