...
{ 
  ...
  Ghat[0] = 0.8660254037844386*fUpwind[0]*hamil[1]; 
  Ghat[1] = 0.8660254037844386*fUpwind[1]*hamil[1]; 
  Ghat[2] = 0.8660254037844386*hamil[1]*fUpwind[2]; 
  Ghat[3] = 0.8660254037844386*hamil[1]*fUpwind[3]; 
  Ghat[4] = 0.8660254037844386*hamil[1]*fUpwind[4]; 
  Ghat[5] = 0.8660254037844386*hamil[1]*fUpwind[5]; 
  Ghat[6] = 0.8660254037844386*hamil[1]*fUpwind[6]; 
  Ghat[7] = 0.8660254037844386*hamil[1]*fUpwind[7]; 
