...
{ 
  ...
  hamil[0] = 0.7071067811865475*hamil_vx_nodal[1]+0.7071067811865475*hamil_vx_nodal[0]; 
  hamil[1] = 0.408248290463863*hamil_vx_nodal[1]-0.408248290463863*hamil_vx_nodal[0]; 
