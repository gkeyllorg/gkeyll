...
{ 
  ...
  hamil[0] = 0.11785113019775789*hamil_vx_nodal[3]+0.5892556509887895*hamil_vx_nodal[2]+0.5892556509887895*hamil_vx_nodal[1]+0.11785113019775789*hamil_vx_nodal[0]; 
  hamil[1] = 0.20412414523193148*hamil_vx_nodal[3]+0.4564354645876384*hamil_vx_nodal[2]-0.4564354645876384*hamil_vx_nodal[1]-0.20412414523193148*hamil_vx_nodal[0]; 
  hamil[2] = 0.2635231383473649*hamil_vx_nodal[3]-0.2635231383473649*hamil_vx_nodal[2]-0.2635231383473649*hamil_vx_nodal[1]+0.2635231383473649*hamil_vx_nodal[0]; 
  hamil[3] = 0.13363062095621214*hamil_vx_nodal[3]-0.29880715233359834*hamil_vx_nodal[2]+0.29880715233359834*hamil_vx_nodal[1]-0.13363062095621214*hamil_vx_nodal[0]; 
