...
{ 
  ...
  if (dir == 3) { 
  out[0] += 0.4330127018922193*alpha[2]*dv12*jacob_vz_inv; 
  out[1] += 0.4330127018922193*alpha[5]*dv12*jacob_vz_inv; 
  out[2] += (0.38729833462074165*alpha[12]+0.4330127018922193*alpha[0])*dv12*jacob_vz_inv; 
  out[3] += 0.4330127018922193*alpha[7]*dv12*jacob_vz_inv; 
  out[4] += 0.4330127018922193*alpha[9]*dv12*jacob_vz_inv; 
  out[5] += (0.3872983346207417*alpha[20]+0.4330127018922193*alpha[1])*dv12*jacob_vz_inv; 
  out[6] += 0.4330127018922193*alpha[15]*dv12*jacob_vz_inv; 
  out[7] += (0.3872983346207417*alpha[22]+0.4330127018922193*alpha[3])*dv12*jacob_vz_inv; 
  out[8] += 0.4330127018922193*alpha[16]*dv12*jacob_vz_inv; 
  out[9] += (0.3872983346207417*alpha[26]+0.4330127018922193*alpha[4])*dv12*jacob_vz_inv; 
  out[10] += 0.4330127018922193*alpha[18]*dv12*jacob_vz_inv; 
  out[11] += 0.43301270189221935*alpha[19]*dv12*jacob_vz_inv; 
  out[12] += 0.38729833462074165*alpha[2]*dv12*jacob_vz_inv; 
  out[13] += 0.43301270189221935*alpha[24]*dv12*jacob_vz_inv; 
  out[14] += 0.43301270189221935*alpha[29]*dv12*jacob_vz_inv; 
  out[15] += (0.38729833462074165*alpha[33]+0.4330127018922193*alpha[6])*dv12*jacob_vz_inv; 
  out[16] += (0.38729833462074165*alpha[36]+0.4330127018922193*alpha[8])*dv12*jacob_vz_inv; 
  out[17] += 0.4330127018922193*alpha[31]*dv12*jacob_vz_inv; 
  out[18] += (0.38729833462074165*alpha[38]+0.4330127018922193*alpha[10])*dv12*jacob_vz_inv; 
  out[19] += 0.43301270189221935*alpha[11]*dv12*jacob_vz_inv; 
  out[20] += 0.3872983346207417*alpha[5]*dv12*jacob_vz_inv; 
  out[21] += 0.43301270189221935*alpha[32]*dv12*jacob_vz_inv; 
  out[22] += 0.3872983346207417*alpha[7]*dv12*jacob_vz_inv; 
  out[23] += 0.43301270189221935*alpha[34]*dv12*jacob_vz_inv; 
  out[24] += 0.43301270189221935*alpha[13]*dv12*jacob_vz_inv; 
  out[25] += 0.43301270189221935*alpha[35]*dv12*jacob_vz_inv; 
  out[26] += 0.3872983346207417*alpha[9]*dv12*jacob_vz_inv; 
  out[27] += 0.43301270189221935*alpha[40]*dv12*jacob_vz_inv; 
  out[28] += 0.43301270189221935*alpha[41]*dv12*jacob_vz_inv; 
  out[29] += 0.43301270189221935*alpha[14]*dv12*jacob_vz_inv; 
  out[30] += 0.43301270189221935*alpha[43]*dv12*jacob_vz_inv; 
  out[31] += (0.3872983346207417*alpha[45]+0.4330127018922193*alpha[17])*dv12*jacob_vz_inv; 
  out[32] += 0.43301270189221935*alpha[21]*dv12*jacob_vz_inv; 
  out[33] += 0.38729833462074165*alpha[15]*dv12*jacob_vz_inv; 
  out[34] += 0.43301270189221935*alpha[23]*dv12*jacob_vz_inv; 
  out[35] += 0.43301270189221935*alpha[25]*dv12*jacob_vz_inv; 
  out[36] += 0.38729833462074165*alpha[16]*dv12*jacob_vz_inv; 
  out[37] += 0.43301270189221935*alpha[44]*dv12*jacob_vz_inv; 
  out[38] += 0.38729833462074165*alpha[18]*dv12*jacob_vz_inv; 
  out[39] += 0.43301270189221935*alpha[46]*dv12*jacob_vz_inv; 
  out[40] += 0.43301270189221935*alpha[27]*dv12*jacob_vz_inv; 
  out[41] += 0.43301270189221935*alpha[28]*dv12*jacob_vz_inv; 
  out[42] += 0.43301270189221935*alpha[47]*dv12*jacob_vz_inv; 
  out[43] += 0.43301270189221935*alpha[30]*dv12*jacob_vz_inv; 
  out[44] += 0.43301270189221935*alpha[37]*dv12*jacob_vz_inv; 
  out[45] += 0.3872983346207417*alpha[31]*dv12*jacob_vz_inv; 
  out[46] += 0.43301270189221935*alpha[39]*dv12*jacob_vz_inv; 
  out[47] += 0.43301270189221935*alpha[42]*dv12*jacob_vz_inv; 
  } 
