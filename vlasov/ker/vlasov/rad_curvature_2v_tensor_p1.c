...
GKYL_CU_DH void rad_curvature_2v_tensor_p1(const double *w, const double *dxv, const double *vmap, 
...
{ 
  ...
  rad_nodal_vy[0] = -1.0/t_cool*(pow(-(1.8708286933869707*vmap_vy[3])+1.5811388300841895*vmap_vy[2]-1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0], 3.0)*fabs(-(1.8708286933869707*vmap_vy[3])+1.5811388300841895*vmap_vy[2]-1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0]));
  ...
  rad_nodal_vy[1] = -1.0/t_cool*(pow(-(1.8708286933869707*vmap_vy[3])+1.5811388300841895*vmap_vy[2]-1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0], 3.0)*fabs(-(1.8708286933869707*vmap_vy[3])+1.5811388300841895*vmap_vy[2]-1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0]));
  ...
  rad_nodal_vy[2] = -1.0/t_cool*(pow(1.8708286933869707*vmap_vy[3]+1.5811388300841895*vmap_vy[2]+1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0], 3.0)*fabs(1.8708286933869707*vmap_vy[3]+1.5811388300841895*vmap_vy[2]+1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0]));
  ...
  rad_nodal_vy[3] = -1.0/t_cool*(pow(1.8708286933869707*vmap_vy[3]+1.5811388300841895*vmap_vy[2]+1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0], 3.0)*fabs(1.8708286933869707*vmap_vy[3]+1.5811388300841895*vmap_vy[2]+1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0]));
