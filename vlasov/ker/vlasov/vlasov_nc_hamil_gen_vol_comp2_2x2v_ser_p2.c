...
{ 
  ...
  out[36] += 0.4330127018922193*alpha[36]*dx11*jacob_cy_inv; 
  out[37] += 0.4330127018922193*alpha[37]*dx11*jacob_cy_inv; 
  out[38] += 0.4330127018922193*alpha[38]*dx11*jacob_cy_inv; 
  out[39] += 0.4330127018922193*alpha[39]*dx11*jacob_cy_inv; 
  out[40] += 0.4330127018922193*alpha[40]*dx11*jacob_cy_inv; 
  out[41] += 0.4330127018922193*alpha[41]*dx11*jacob_cy_inv; 
  out[42] += 0.4330127018922193*alpha[42]*dx11*jacob_cy_inv; 
  out[43] += 0.4330127018922193*alpha[43]*dx11*jacob_cy_inv; 
  out[44] += 0.4330127018922193*alpha[44]*dx11*jacob_cy_inv; 
  out[45] += 0.4330127018922193*alpha[45]*dx11*jacob_cy_inv; 
  out[46] += 0.4330127018922193*alpha[46]*dx11*jacob_cy_inv; 
  out[47] += 0.4330127018922193*alpha[47]*dx11*jacob_cy_inv; 
  } 
