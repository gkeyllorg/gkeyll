...
{ 
  ...
  Ghat[0] = 1.369306393762915*fUpwind[1]*hamil[7]+0.6123724356957944*fUpwind[0]*hamil[1]; 
  Ghat[1] = 1.224744871391589*fUpwind[7]*hamil[7]+1.369306393762915*fUpwind[0]*hamil[7]+0.6123724356957944*fUpwind[1]*hamil[1]; 
  Ghat[2] = 1.369306393762915*fUpwind[4]*hamil[7]+0.6123724356957944*hamil[1]*fUpwind[2]; 
  Ghat[3] = 1.369306393762915*fUpwind[5]*hamil[7]+0.6123724356957944*hamil[1]*fUpwind[3]; 
  Ghat[4] = 1.224744871391589*hamil[7]*fUpwind[11]+1.369306393762915*fUpwind[2]*hamil[7]+0.6123724356957944*hamil[1]*fUpwind[4]; 
  Ghat[5] = 1.224744871391589*hamil[7]*fUpwind[13]+1.369306393762915*fUpwind[3]*hamil[7]+0.6123724356957944*hamil[1]*fUpwind[5]; 
  Ghat[6] = 1.369306393762915*hamil[7]*fUpwind[10]+0.6123724356957944*hamil[1]*fUpwind[6]; 
  Ghat[7] = 1.224744871391589*fUpwind[1]*hamil[7]+0.6123724356957944*hamil[1]*fUpwind[7]; 
  Ghat[8] = 1.369306393762915*hamil[7]*fUpwind[12]+0.6123724356957944*hamil[1]*fUpwind[8]; 
  Ghat[9] = 1.369306393762915*hamil[7]*fUpwind[15]+0.6123724356957944*hamil[1]*fUpwind[9]; 
  Ghat[10] = 1.224744871391589*hamil[7]*fUpwind[17]+0.6123724356957944*hamil[1]*fUpwind[10]+1.369306393762915*fUpwind[6]*hamil[7]; 
  Ghat[11] = 0.6123724356957944*hamil[1]*fUpwind[11]+1.224744871391589*fUpwind[4]*hamil[7]; 
  Ghat[12] = 0.6123724356957944*hamil[1]*fUpwind[12]+1.369306393762915*hamil[7]*fUpwind[8]; 
  Ghat[13] = 0.6123724356957944*hamil[1]*fUpwind[13]+1.224744871391589*fUpwind[5]*hamil[7]; 
  Ghat[14] = 1.369306393762915*hamil[7]*fUpwind[18]+0.6123724356957944*hamil[1]*fUpwind[14]; 
  Ghat[15] = 0.6123724356957944*hamil[1]*fUpwind[15]+1.369306393762915*hamil[7]*fUpwind[9]; 
  Ghat[16] = 1.369306393762915*hamil[7]*fUpwind[19]+0.6123724356957944*hamil[1]*fUpwind[16]; 
  Ghat[17] = 0.6123724356957944*hamil[1]*fUpwind[17]+1.224744871391589*hamil[7]*fUpwind[10]; 
  Ghat[18] = 0.6123724356957944*hamil[1]*fUpwind[18]+1.369306393762915*hamil[7]*fUpwind[14]; 
  Ghat[19] = 0.6123724356957944*hamil[1]*fUpwind[19]+1.369306393762915*hamil[7]*fUpwind[16]; 
