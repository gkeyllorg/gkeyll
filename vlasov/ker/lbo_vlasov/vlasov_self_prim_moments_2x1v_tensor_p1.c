...
GKYL_CU_DH void vlasov_self_prim_moments_2x1v_tensor_p1(struct gkyl_mat *A, struct gkyl_mat *rhs, const double *moms, const double *boundary_corrections, const double *nu) 
{ 
  ...
  gkyl_mat_set(A,4,4,0.5*m0r[0]-0.5*cEr[0]); 
  gkyl_mat_set(A,4,5,0.5*m0r[1]-0.5*cEr[1]); 
  gkyl_mat_set(A,4,6,0.5*m0r[2]-0.5*cEr[2]); 
  gkyl_mat_set(A,4,7,0.5*m0r[3]-0.5*cEr[3]); 
  gkyl_mat_set(A,5,4,0.5*m0r[1]-0.5*cEr[1]); 
  gkyl_mat_set(A,5,5,0.5*m0r[0]-0.5*cEr[0]); 
  gkyl_mat_set(A,5,6,0.5*m0r[3]-0.5*cEr[3]); 
  gkyl_mat_set(A,5,7,0.5*m0r[2]-0.5*cEr[2]); 
  gkyl_mat_set(A,6,4,0.5*m0r[2]-0.5*cEr[2]); 
  gkyl_mat_set(A,6,5,0.5*m0r[3]-0.5*cEr[3]); 
  gkyl_mat_set(A,6,6,0.5*m0r[0]-0.5*cEr[0]); 
  gkyl_mat_set(A,6,7,0.5*m0r[1]-0.5*cEr[1]); 
  gkyl_mat_set(A,7,4,0.5*m0r[3]-0.5*cEr[3]); 
  gkyl_mat_set(A,7,5,0.5*m0r[2]-0.5*cEr[2]); 
  gkyl_mat_set(A,7,6,0.5*m0r[1]-0.5*cEr[1]); 
  gkyl_mat_set(A,7,7,0.5*m0r[0]-0.5*cEr[0]); 
