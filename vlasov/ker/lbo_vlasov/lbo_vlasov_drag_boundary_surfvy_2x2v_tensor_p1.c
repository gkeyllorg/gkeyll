...
GKYL_CU_DH double lbo_vlasov_drag_boundary_surfvy_2x2v_tensor_p1(const double *w, const double *dxv, const double *nuSum, const double *nuPrimMomsSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  out[26] += 1.224744871391589*Ghat[10]*rdv2; 
  out[27] += 1.5811388300841895*Ghat[4]*rdv2; 
  out[28] += 1.5811388300841895*Ghat[5]*rdv2; 
  out[29] += 1.5811388300841895*Ghat[6]*rdv2; 
  out[30] += 1.5811388300841895*Ghat[7]*rdv2; 
  out[31] += 1.224744871391589*Ghat[11]*rdv2; 
  out[32] += 1.5811388300841898*Ghat[8]*rdv2; 
