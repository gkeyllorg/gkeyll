...
{ 
  ...
  double f_xx[6] = {0.0}; 
  f_xx[0] = 0.6708203932499369*fr[4]+0.6708203932499369*fl[4]-1.3416407864998738*fc[4]-1.190784930203603*fr[2]+1.190784930203603*fl[2]+0.9375*fr[0]+0.9375*fl[0]-1.875*fc[0]; 
  f_xx[1] = 0.6708203932499369*fr[5]+0.6708203932499369*fl[5]-1.3416407864998738*fc[5]-1.190784930203603*fr[3]+1.190784930203603*fl[3]+0.9375*fr[1]+0.9375*fl[1]-1.875*fc[1]; 
  ...
  f_xx[5] = -(0.140625*fr[5])-0.140625*fl[5]-6.28125*fc[5]-0.30257682392245444*fr[3]+0.30257682392245444*fl[3]+0.41926274578121053*fr[1]+0.41926274578121053*fl[1]-0.8385254915624211*fc[1]; 
