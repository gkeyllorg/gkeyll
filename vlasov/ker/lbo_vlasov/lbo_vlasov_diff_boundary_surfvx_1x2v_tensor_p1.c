...
GKYL_CU_DH double lbo_vlasov_diff_boundary_surfvx_1x2v_tensor_p1(const double *w, const double *dxv, const double *nuSum, const double *nuPrimMomsSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  vol_incr[7] = 4.743416490252569*fSkin[1]*nuVtSqSum[1]+4.743416490252569*fSkin[0]*nuVtSqSum[0]; 
  vol_incr[10] = 4.743416490252569*fSkin[0]*nuVtSqSum[1]+4.743416490252569*nuVtSqSum[0]*fSkin[1]; 
  vol_incr[11] = 4.743416490252569*nuVtSqSum[1]*fSkin[5]+4.743416490252569*nuVtSqSum[0]*fSkin[3]; 
  vol_incr[14] = 4.743416490252569*nuVtSqSum[0]*fSkin[5]+4.743416490252569*nuVtSqSum[1]*fSkin[3]; 
  vol_incr[16] = 4.743416490252569*nuVtSqSum[1]*fSkin[12]+4.743416490252569*nuVtSqSum[0]*fSkin[8]; 
  vol_incr[17] = 4.743416490252569*nuVtSqSum[0]*fSkin[12]+4.743416490252569*nuVtSqSum[1]*fSkin[8]; 
  ...
  edgeSurf[0] = -(0.6708203932499369*fSkin[7])+0.6708203932499369*fEdge[7]-1.190784930203603*fSkin[2]-1.190784930203603*fEdge[2]-0.9375*fSkin[0]+0.9375*fEdge[0]; 
  edgeSurf[1] = -(0.6708203932499369*fSkin[10])+0.6708203932499369*fEdge[10]-1.190784930203603*fSkin[4]-1.190784930203603*fEdge[4]-0.9375*fSkin[1]+0.9375*fEdge[1]; 
  edgeSurf[2] = -(1.5855025573536612*fSkin[7])+0.7382874503707888*fEdge[7]-2.671875*fSkin[2]-1.453125*fEdge[2]-2.0568103339880417*fSkin[0]+1.190784930203603*fEdge[0]; 
  edgeSurf[3] = -(0.6708203932499369*fSkin[11])+0.6708203932499369*fEdge[11]-1.190784930203603*fSkin[6]-1.190784930203603*fEdge[6]-0.9375*fSkin[3]+0.9375*fEdge[3]; 
  edgeSurf[4] = -(1.5855025573536612*fSkin[10])+0.7382874503707888*fEdge[10]-2.671875*fSkin[4]-1.453125*fEdge[4]-2.0568103339880417*fSkin[1]+1.190784930203603*fEdge[1]; 
  edgeSurf[5] = -(0.6708203932499369*fSkin[14])+0.6708203932499369*fEdge[14]-1.190784930203603*fSkin[9]-1.190784930203603*fEdge[9]-0.9375*fSkin[5]+0.9375*fEdge[5]; 
  edgeSurf[6] = -(1.5855025573536612*fSkin[11])+0.7382874503707888*fEdge[11]-2.671875*fSkin[6]-1.453125*fEdge[6]-2.0568103339880417*fSkin[3]+1.190784930203603*fEdge[3]; 
  edgeSurf[7] = -(3.140625*fSkin[7])-0.140625*fEdge[7]-5.022775277112744*fSkin[2]-0.3025768239224545*fEdge[2]-3.7733647120308955*fSkin[0]+0.4192627457812106*fEdge[0]; 
  edgeSurf[8] = -(0.6708203932499369*fSkin[16])+0.6708203932499369*fEdge[16]-1.190784930203603*fSkin[13]-1.190784930203603*fEdge[13]-0.9375*fSkin[8]+0.9375*fEdge[8]; 
  edgeSurf[9] = -(1.5855025573536612*fSkin[14])+0.7382874503707888*fEdge[14]-2.671875*fSkin[9]-1.453125*fEdge[9]-2.0568103339880417*fSkin[5]+1.190784930203603*fEdge[5]; 
  edgeSurf[10] = -(3.140625*fSkin[10])-0.140625*fEdge[10]-5.022775277112744*fSkin[4]-0.30257682392245444*fEdge[4]-3.773364712030894*fSkin[1]+0.41926274578121053*fEdge[1]; 
  edgeSurf[11] = -(3.140625*fSkin[11])-0.140625*fEdge[11]-5.022775277112744*fSkin[6]-0.30257682392245444*fEdge[6]-3.773364712030894*fSkin[3]+0.41926274578121053*fEdge[3]; 
  edgeSurf[12] = -(0.6708203932499369*fSkin[17])+0.6708203932499369*fEdge[17]-1.190784930203603*fSkin[15]-1.190784930203603*fEdge[15]-0.9375*fSkin[12]+0.9375*fEdge[12]; 
  edgeSurf[13] = -(1.5855025573536612*fSkin[16])+0.7382874503707888*fEdge[16]-2.671875*fSkin[13]-1.453125*fEdge[13]-2.0568103339880417*fSkin[8]+1.190784930203603*fEdge[8]; 
  edgeSurf[14] = -(3.140625*fSkin[14])-0.140625*fEdge[14]-5.022775277112744*fSkin[9]-0.3025768239224545*fEdge[9]-3.7733647120308955*fSkin[5]+0.4192627457812106*fEdge[5]; 
  edgeSurf[15] = -(1.5855025573536612*fSkin[17])+0.7382874503707888*fEdge[17]-2.671875*fSkin[15]-1.453125*fEdge[15]-2.0568103339880417*fSkin[12]+1.190784930203603*fEdge[12]; 
  edgeSurf[16] = -(3.140625*fSkin[16])-0.140625*fEdge[16]-5.022775277112744*fSkin[13]-0.30257682392245444*fEdge[13]-3.7733647120308955*fSkin[8]+0.4192627457812106*fEdge[8]; 
  edgeSurf[17] = -(3.140625*fSkin[17])-0.140625*fEdge[17]-5.022775277112744*fSkin[15]-0.3025768239224545*fEdge[15]-3.773364712030894*fSkin[12]+0.41926274578121053*fEdge[12]; 

  double boundSurf[18] = {0.0}; 
  boundSurf[2] = 1.9364916731037085*fSkin[7]-1.5*fSkin[2]+0.8660254037844386*fSkin[0]; 
  boundSurf[4] = 1.9364916731037085*fSkin[10]-1.5*fSkin[4]+0.8660254037844386*fSkin[1]; 
  boundSurf[6] = 1.9364916731037085*fSkin[11]-1.5*fSkin[6]+0.8660254037844386*fSkin[3]; 
  boundSurf[7] = -(7.5*fSkin[7])+5.809475019311125*fSkin[2]-3.3541019662496847*fSkin[0]; 
  boundSurf[9] = 1.9364916731037085*fSkin[14]-1.5*fSkin[9]+0.8660254037844386*fSkin[5]; 
  boundSurf[10] = -(7.5*fSkin[10])+5.809475019311126*fSkin[4]-3.3541019662496843*fSkin[1]; 
  boundSurf[11] = -(7.5*fSkin[11])+5.809475019311126*fSkin[6]-3.3541019662496843*fSkin[3]; 
  boundSurf[13] = 1.9364916731037085*fSkin[16]-1.5*fSkin[13]+0.8660254037844387*fSkin[8]; 
  boundSurf[14] = -(7.5*fSkin[14])+5.809475019311125*fSkin[9]-3.3541019662496847*fSkin[5]; 
  boundSurf[15] = 1.9364916731037085*fSkin[17]-1.5*fSkin[15]+0.8660254037844387*fSkin[12]; 
  boundSurf[16] = -(7.5*fSkin[16])+5.809475019311126*fSkin[13]-3.3541019662496847*fSkin[8]; 
  boundSurf[17] = -(7.5*fSkin[17])+5.809475019311125*fSkin[15]-3.3541019662496843*fSkin[12]; 
