...
GKYL_CU_DH double lbo_vlasov_drag_boundary_surfvz_1x3v_tensor_p1(const double *w, const double *dxv, const double *nuSum, const double *nuPrimMomsSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  out[24] += 1.5811388300841898*Ghat[1]*rdv2; 
  out[25] += 1.5811388300841898*Ghat[2]*rdv2; 
  out[26] += 1.5811388300841898*Ghat[3]*rdv2; 
  out[27] += 1.224744871391589*Ghat[9]*rdv2; 
  out[28] += 0.7071067811865475*Ghat[14]*rdv2; 
  out[29] += 0.7071067811865475*Ghat[15]*rdv2; 
  out[30] += 1.224744871391589*Ghat[10]*rdv2; 
  out[31] += 1.224744871391589*Ghat[11]*rdv2; 
  out[32] += 1.224744871391589*Ghat[12]*rdv2; 
  out[33] += 1.224744871391589*Ghat[13]*rdv2; 
  out[34] += 1.5811388300841895*Ghat[4]*rdv2; 
  out[35] += 1.5811388300841895*Ghat[5]*rdv2; 
  out[36] += 1.5811388300841895*Ghat[6]*rdv2; 
  out[37] += 0.7071067811865475*Ghat[16]*rdv2; 
  out[38] += 1.5811388300841895*Ghat[7]*rdv2; 
  out[39] += 1.5811388300841895*Ghat[8]*rdv2; 
  out[40] += 1.224744871391589*Ghat[14]*rdv2; 
  out[41] += 1.224744871391589*Ghat[15]*rdv2; 
  out[42] += 1.5811388300841898*Ghat[9]*rdv2; 
  out[43] += 0.7071067811865475*Ghat[17]*rdv2; 
  out[44] += 1.224744871391589*Ghat[16]*rdv2; 
  out[45] += 1.5811388300841898*Ghat[10]*rdv2; 
  out[46] += 1.5811388300841898*Ghat[11]*rdv2; 
  out[47] += 1.5811388300841898*Ghat[12]*rdv2; 
  out[48] += 1.5811388300841898*Ghat[13]*rdv2; 
  out[49] += 1.224744871391589*Ghat[17]*rdv2; 
  out[50] += 1.5811388300841895*Ghat[14]*rdv2; 
