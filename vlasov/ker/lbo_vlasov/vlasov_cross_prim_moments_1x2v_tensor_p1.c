...
GKYL_CU_DH void vlasov_cross_prim_moments_1x2v_tensor_p1(struct gkyl_mat *A, struct gkyl_mat *rhs, const double *alphaE, const double m_self, const double *moms_self, const double *prim_mom_self, const double m_other, const double *moms_other, const double *prim_mom_other, const double *boundary_corrections, const double *nu) 
{ 
  // A:                    Left-side matrix. 
  ...
  momRHS[2] += -(0.7071067811865475*((alphaE[1]*u_selfr[3]-1.0*alphaE[1]*u_otherr[3]+alphaE[0]*u_selfr[2]-1.0*alphaE[0]*u_otherr[2])*m_sumDms-2.8284271247461907*m1r[2])); 
  momRHS[3] += -(0.7071067811865475*((alphaE[0]*u_selfr[3]-1.0*alphaE[0]*u_otherr[3]+alphaE[1]*u_selfr[2]-1.0*alphaE[1]*u_otherr[2])*m_sumDms-2.8284271247461907*m1r[3])); 
  ...
  double enRHS[2] = {0.0}; 
  enRHS[0] = (1.4142135623730951*alphaE[1]*vtsq_other[1]*m_other)/m_self+(1.4142135623730951*alphaE[0]*vtsq_other[0]*m_other)/m_self+(0.3535533905932737*alphaE[1]*uSumSq[1]*m_diff)/m_self+(0.3535533905932737*alphaE[0]*uSumSq[0]*m_diff)/m_self-1.4142135623730951*alphaE[1]*vtsq_self[1]-1.4142135623730951*alphaE[0]*vtsq_self[0]-1.0*uM1Self[0]-1.0*uM1Other[0]+4.0*m2r[0]; 
  enRHS[1] = (1.4142135623730951*alphaE[0]*vtsq_other[1]*m_other)/m_self+(1.4142135623730951*vtsq_other[0]*alphaE[1]*m_other)/m_self+(0.3535533905932737*alphaE[0]*uSumSq[1]*m_diff)/m_self+(0.3535533905932737*uSumSq[0]*alphaE[1]*m_diff)/m_self-1.4142135623730951*alphaE[0]*vtsq_self[1]-1.0*uM1Self[1]-1.0*uM1Other[1]+4.0*m2r[1]-1.4142135623730951*vtsq_self[0]*alphaE[1]; 
