...
evalDensityInit(double t, const double *GKYL_RESTRICT xn, double *GKYL_RESTRICT fout, void *ctx)
{
  ...
  n = n * exp(
            -((theta - theta_bump_0) * (theta - theta_bump_0) +
              (phi - phi_bump_0) * (phi - phi_bump_0) * sin(theta) * sin(theta)) /
            (0.5 * L_bump)
          );
...
evalHamiltonian(double t, const double *GKYL_RESTRICT xn, double *GKYL_RESTRICT fout, void *ctx)
{
  ...
  double hamiltonian = (0.5 * inv_metric_theta_theta * p_theta_dot * p_theta_dot) +
                       ...
                       (0.5 * inv_metric_phi_phi * p_phi_dot * p_phi_dot) -
                       omega * p_phi_dot; // Canonical Hamiltonian.
