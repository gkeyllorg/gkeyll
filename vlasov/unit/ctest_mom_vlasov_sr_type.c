...
test_mom_sr_1x3v()
{
  ...
  struct gkyl_mom_type *m0 =
    gkyl_mom_vlasov_sr_new(&cbasis, &pbasis, &crange, &vrange, GKYL_F_MOMENT_M0, false);
  struct gkyl_mom_type *m1 =
    gkyl_mom_vlasov_sr_new(&cbasis, &pbasis, &crange, &vrange, GKYL_F_MOMENT_M1, false);
  struct gkyl_mom_type *m2 =
    gkyl_mom_vlasov_sr_new(&cbasis, &pbasis, &crange, &vrange, GKYL_F_MOMENT_M2, false);
  struct gkyl_mom_type *m3 =
    gkyl_mom_vlasov_sr_new(&cbasis, &pbasis, &crange, &vrange, GKYL_F_MOMENT_M3, false);
  struct gkyl_mom_type *ni =
    gkyl_mom_vlasov_sr_new(&cbasis, &pbasis, &crange, &vrange, GKYL_F_MOMENT_NI, false);
  struct gkyl_mom_type *tij =
    gkyl_mom_vlasov_sr_new(&cbasis, &pbasis, &crange, &vrange, GKYL_F_MOMENT_TIJ, false);
...
test_int_mom_sr_1x3v()
{
  ...
  struct gkyl_mom_type *intm =
    gkyl_int_mom_vlasov_sr_new(&cbasis, &pbasis, &crange, &vrange, GKYL_F_MOMENT_M0ENERGYM3, false);
...
TEST_LIST =
  {{"mom_sr_1x3v", test_mom_sr_1x3v}, {"int_mom_sr_1x3v", test_int_mom_sr_1x3v}, {NULL, NULL}};
