...
test_diffusion_vlasov_1x1v_const()
{
  ...
  struct gkyl_dg_eqn *eqn =
    gkyl_dg_diffusion_vlasov_new(&pbasis, &cbasis, true, diff_in_dir, diff_order, &drange, false);
...
test_diffusion_vlasov_1x1v_varcoeff()
{
  ...
  struct gkyl_dg_eqn *eqn =
    gkyl_dg_diffusion_vlasov_new(&pbasis, &cbasis, false, diff_in_dir, diff_order, &drange, false);
