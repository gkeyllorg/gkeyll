...
test_vp_phi()
{
  ...
  struct gkyl_dg_eqn *eqn = gkyl_dg_vlasov_poisson_new(
    &cbasis, &pbasis, &crange, &prange, GKYL_MODEL_DEFAULT, GKYL_FIELD_PHI, false
  );
...
test_vp_phi_ext_potentials()
{
  ...
  struct gkyl_dg_eqn *eqn = gkyl_dg_vlasov_poisson_new(
    &cbasis, &pbasis, &crange, &prange, GKYL_MODEL_DEFAULT, GKYL_FIELD_PHI_EXT_POTENTIALS, false
  );
...
test_vp_phi_ext_fields()
{
  ...
  struct gkyl_dg_eqn *eqn = gkyl_dg_vlasov_poisson_new(
    &cbasis, &pbasis, &crange, &prange, GKYL_MODEL_DEFAULT, GKYL_FIELD_PHI_EXT_FIELDS, false
  );
