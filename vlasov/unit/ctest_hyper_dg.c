...
test_vlasov_1x2v_p2_(bool use_gpu)
{
  ...
  const double exp0[] = {1.2236372998891958e+00,  2.0105903561583763e-01,  -5.1419282362326753e+00,
                         -2.0352048757787333e+00, -3.1394800811609201e+01, -5.8085102299277480e+00,
                         -5.1728224653103201e+00, 1.6650094262740243e+01,  -5.0331198175173064e-01,
                         6.1804101443921522e-01,  -3.0931309818069451e+01, -2.4166487365871351e+01,
                         -1.1949509605874356e+01, 9.2106442019431967e+00,  -6.6446814763038498e-01,
                         1.2077341612159545e+01,  3.4825387939850700e+00,  -2.3867523859361569e+01,
                         -1.1804252614108304e+01, 1.8849579738214938e+01};
  ...
  //for(int i=0; i<rhs->ncomp; i++) printf("%.16e\n", rhs_d[i]);
  const double exp1[] = {7.9777292154304547e-01,  -2.7182122357080729e+00, -3.1823319852967562e+00,
                         -1.3560732323031073e+00, -9.3361523823747120e+01, -6.4546439524194774e+00,
                         -3.0046857486230238e+00, 5.7739758711920011e+01,  -5.5255780047650804e-01,
                         5.4569313596808011e-01,  -9.3082985569032914e+01, -5.9264062443889756e+01,
                         -3.4252162191461366e+01, 5.2936631523369066e+01,  -5.5255780047650571e-01,
                         3.7711009940704315e+01,  2.8771855264879638e+00,  -5.8883885687489283e+01,
                         -3.4263348605987986e+01, 4.1758987770172105e+01};
  for (int j = 0; j < rhs->ncomp; ++j) {
...
test_vlasov_2x3v_p1_(bool use_gpu)
{
  ...
  //  printf("first cell rhs\n");
  //for(int i=0; i<rhs->ncomp; i++) printf("%.16e\n", rhs_d[i]);
  const double exp0[] = {5.8503928145486075e+00,  1.3348107973742653e+01,  -8.3015588600670664e+00,
                         -5.1601563129102523e-01, 3.3662725617516118e+00,  -6.0220290457402514e+00,
                         -2.3066605359371479e+01, 1.1795492527988509e+01,  -1.2094070618291957e+01,
                         1.6328023879915964e+01,  -5.9571695141905820e+00, -9.4566262621926439e-02,
                         -1.3664800178573332e+01, 3.2863247869002210e+00,  -2.3221330832899003e+00,
                         -5.5061118408615184e-01, -1.9749990082666812e+01, 2.5652234998826916e+01,
                         -1.9592570200054443e+01, 9.2140945629575306e+00,  -2.2973923054182546e+01,
                         2.2017046005263165e+01,  -1.1646193018869390e+01, 1.1830908772108357e+01,
                         -1.2129487374637437e+01, -5.9473538681355222e+00, -2.8902000068602643e+01,
                         3.1341669905686420e+01,  -1.9716623728746605e+01, 1.7728926461597514e+01,
                         -1.2708781703202801e+01, 3.1935276140332110e+01};
  ...
  //  printf("second cell rhs\n");
  //for(int i=0; i<rhs->ncomp; i++) printf("%.16e\n", rhs_d[i]);
  const double exp1[] = {-2.3607695154586722e-01, 7.2773300308759890e+00,  -5.3317823194938491e+01,
                         4.4392304845413322e-01,  -2.3607695154587002e-01, 2.3607695154586483e-01,
                         -5.9943625779670839e+01, 6.5845536531609365e+00,  -5.3803105038245278e+01,
                         7.7623628507452853e+00,  -5.2625413028160921e+01, 2.3607695154587174e-01,
                         -7.7623848234015105e+00, 5.2625566836754672e+01,  -2.3607695154586925e-01,
                         4.4392304845412967e-01,  -5.9944211717170838e+01, 6.0152116407829062e+01,
                         -7.7624287687140043e+00, 5.2625874453942174e+01,  -6.0152292189079098e+01,
                         7.7624507413702837e+00,  -5.2626028262535925e+01, 6.5846708406609364e+00,
                         -5.3803925350745281e+01, 4.4392304845413200e-01,  -6.0152643751579092e+01,
                         6.0152702345329089e+01,  -5.9944914842170824e+01, 7.0696890120927236e+00,
                         -5.3111412644905229e+01, 6.0152936720329066e+01};
