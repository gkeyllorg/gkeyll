...
void test_bc(int cdim, int vdim, int poly_order, char *boundary_type, bool useGPU)
{
  ...
  for (int bc_dir = 0; bc_dir < cdim; bc_dir++) {
    ...
    if (strcmp(boundary_type, "reflect") == 0) {
      bclo = gkyl_bc_basic_new(
        bc_dir, GKYL_LOWER_EDGE, GKYL_BC_DISTF_REFLECT, basis_cu, &skin_ghost.lower_skin[bc_dir],
        &skin_ghost.lower_ghost[bc_dir], distf->ncomp, cdim, useGPU
      );
    } else if (strcmp(boundary_type, "absorb") == 0) {
      bclo = gkyl_bc_basic_new(
        bc_dir, GKYL_LOWER_EDGE, GKYL_BC_ABSORB, basis_cu, &skin_ghost.lower_skin[bc_dir],
        &skin_ghost.lower_ghost[bc_dir], distf->ncomp, cdim, useGPU
      );
    }
    if (useGPU) {
    ...
    if (strcmp(boundary_type, "reflect") == 0) {
      bcup = gkyl_bc_basic_new(
        bc_dir, GKYL_UPPER_EDGE, GKYL_BC_DISTF_REFLECT, basis_cu, &skin_ghost.upper_skin[bc_dir],
        &skin_ghost.upper_ghost[bc_dir], distf->ncomp, cdim, useGPU
      );
    } else if (strcmp(boundary_type, "absorb") == 0) {
      bcup = gkyl_bc_basic_new(
        bc_dir, GKYL_UPPER_EDGE, GKYL_BC_ABSORB, basis_cu, &skin_ghost.upper_skin[bc_dir],
        &skin_ghost.upper_ghost[bc_dir], distf->ncomp, cdim, useGPU
      );
    }
    if (useGPU) {
...
void test_bc_reflect_1x1v_p1()
{
  test_bc(1, 1, 1, "reflect", false);
}
void test_bc_reflect_1x2v_p1()
{
  test_bc(1, 2, 1, "reflect", false);
}
void test_bc_reflect_2x2v_p1()
{
  test_bc(2, 2, 1, "reflect", false);
}
void test_bc_reflect_3x2v_p1()
{
  test_bc(3, 2, 1, "reflect", false);
}
void test_bc_reflect_1x1v_p2()
{
  test_bc(1, 1, 2, "reflect", false);
}
void test_bc_reflect_1x2v_p2()
{
  test_bc(1, 2, 2, "reflect", false);
}
void test_bc_reflect_2x2v_p2()
{
  test_bc(2, 2, 2, "reflect", false);
}
void test_bc_reflect_3x2v_p2()
{
  test_bc(3, 2, 2, "reflect", false);
}

void test_bc_absorb_1x1v_p1()
{
  test_bc(1, 1, 1, "absorb", false);
}
void test_bc_absorb_1x2v_p1()
{
  test_bc(1, 2, 1, "absorb", false);
}
void test_bc_absorb_2x2v_p1()
{
  test_bc(2, 2, 1, "absorb", false);
}
void test_bc_absorb_3x2v_p1()
{
  test_bc(3, 2, 1, "absorb", false);
}
void test_bc_absorb_1x1v_p2()
{
  test_bc(1, 1, 2, "absorb", false);
}
void test_bc_absorb_1x2v_p2()
{
  test_bc(1, 2, 2, "absorb", false);
}
void test_bc_absorb_2x2v_p2()
{
  test_bc(2, 2, 2, "absorb", false);
}
void test_bc_absorb_3x2v_p2()
{
  test_bc(3, 2, 2, "absorb", false);
}

#ifdef GKYL_HAVE_CUDA
void test_bc_reflect_1x1v_p1_gpu()
{
  test_bc(1, 1, 1, "reflect", true);
}
void test_bc_reflect_1x2v_p1_gpu()
{
  test_bc(1, 2, 1, "reflect", true);
}
void test_bc_reflect_2x2v_p1_gpu()
{
  test_bc(2, 2, 1, "reflect", true);
}
void test_bc_reflect_3x2v_p1_gpu()
{
  test_bc(3, 2, 1, "reflect", true);
}
void test_bc_reflect_1x1v_p2_gpu()
{
  test_bc(1, 1, 2, "reflect", true);
}
void test_bc_reflect_1x2v_p2_gpu()
{
  test_bc(1, 2, 2, "reflect", true);
}
void test_bc_reflect_2x2v_p2_gpu()
{
  test_bc(2, 2, 2, "reflect", true);
}
void test_bc_reflect_3x2v_p2_gpu()
{
  test_bc(3, 2, 2, "reflect", true);
}

void test_bc_absorb_1x1v_p1_gpu()
{
  test_bc(1, 1, 1, "absorb", true);
}
void test_bc_absorb_1x2v_p1_gpu()
{
  test_bc(1, 2, 1, "absorb", true);
}
void test_bc_absorb_2x2v_p1_gpu()
{
  test_bc(2, 2, 1, "absorb", true);
}
void test_bc_absorb_3x2v_p1_gpu()
{
  test_bc(3, 2, 1, "absorb", true);
}
void test_bc_absorb_1x1v_p2_gpu()
{
  test_bc(1, 1, 2, "absorb", true);
}
void test_bc_absorb_1x2v_p2_gpu()
{
  test_bc(1, 2, 2, "absorb", true);
}
void test_bc_absorb_2x2v_p2_gpu()
{
  test_bc(2, 2, 2, "absorb", true);
}
void test_bc_absorb_3x2v_p2_gpu()
{
