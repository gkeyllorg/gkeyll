...
void test_vlasov_null_field()
{
  ...
  struct gkyl_dg_eqn *eqn = gkyl_dg_vlasov_new(
    &cbasis, &pbasis, &crange, &prange, GKYL_MODEL_DEFAULT, GKYL_FIELD_NULL, false
  );
...
void test_vlasov_2x3v()
{
  ...
  struct gkyl_dg_eqn *eqn = gkyl_dg_vlasov_new(
    &cbasis, &pbasis, &crange, &prange, GKYL_MODEL_DEFAULT, GKYL_FIELD_E_B, false
  );
