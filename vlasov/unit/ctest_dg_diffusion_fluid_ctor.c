...
void test_diffusion_fluid_1x_scalar()
{
  ...
  struct gkyl_dg_eqn *eqn =
    gkyl_dg_diffusion_fluid_new(&basis, true, num_eq, diff_in_dir, diff_order, &drange, false);
...
void test_diffusion_fluid_1x_varcoeff()
{
  ...
  struct gkyl_dg_eqn *eqn =
    gkyl_dg_diffusion_fluid_new(&basis, false, num_eq, diff_in_dir, diff_order, &drange, false);
